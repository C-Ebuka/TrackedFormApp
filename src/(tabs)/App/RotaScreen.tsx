...
export default function RotaScreen() {
  ...
  const [showAlertROTA, setShowAlertROTA] = useState(false);
  ...
  const [totalROTADiluentAvailable, setTotalROTADiluentAvailable] = useState('');
  const [vaccine5requiredToMatchROTAAvail, setVaccine5requiredToMatchROTAAvail] = useState('');
...
const handleROTADateChange = (text: string) => {
  setExpiryDate(text);
  const validityMessage: string = isValidDate(text); // Ensure validityMessage is typed as string
  setShowAlertROTA(validityMessage !== 'valid' && text.trim().length > 0);
};
...
const handle2DateChange = (text: string) => {
  ...
  const navigateBackward = () => {
    navigation.navigate('PentaScreen');
  };
  ...
  useEffect(() => {
    ...
    if (openingBalance && diluentOpeningBalance) {
      const ROTAOpening = parseInt(openingBalance);
      const diluentOpening = parseInt(diluentOpeningBalance);
      const diluentMismatchAdjustment = ROTAOpening - diluentOpening;
    ...
    if (vaccineTotal && syringeOpeningBalance) {
      const vaccine5requiredToMatchROTAAvailCalc = parseInt(vaccineTotal) - (Number(syringeOpeningBalance));
      setVaccine5requiredToMatchROTAAvail(vaccine5requiredToMatchROTAAvailCalc.toString()); 
    }
   
    if (diluentOpeningBalance && diluentIssued ) {
      const totalROTADiluentAvailableCalc =  (parseInt(diluentOpeningBalance) + parseInt(diluentIssued));
      setTotalROTADiluentAvailable(totalROTADiluentAvailableCalc.toString());

    }
    
    if (diluentOpeningBalance && vaccineTotal && diluentIssued && totalROTADiluentAvailable) {
      const dilAvailableMismatchCalc = parseInt(vaccineTotal) - (parseInt(totalROTADiluentAvailable));
  ...
  return (
    <ParallaxScrollView
      ...
      <ThemedView style={styles.formContainer}>
        ...
        <ThemedText style={styles.header}>ROTAVIRUS VACCINE LOGISTICS DATA</ThemedText>
        ...
        <View>
        <Text style={styles.label}>ROTAVIRUS VACCINE BATCH NUMBER</Text>
        <TextInput
              style={styles.input}
              placeholder="Enter Rotavirus Vaccine batch number"
              value={batchNumber}
        ...
        <View>
          <Text style={styles.label}>ROTAVIRUS VACCINE EXPIRY DATE [MM/DD/YYYY]</Text>
          <TextInput
            style={styles.input}
            placeholder="Enter Rotavirus Vaccine expiring date. Format: MM/DD/YYYY"
            value={expiryDate}
            onChangeText={handleROTADateChange}
          />
          {showAlertROTA && (
        ...
        <View>
        <Text style={styles.label}>ROTAVIRUS DILUENT BATCH NUMBER</Text>
        <TextInput
              style={styles.input}
              placeholder="Enter Rotavirus Diluent batch number"
        ...
        <View>
          <Text style={styles.label}>ROTAVIRUS DILUENT EXPIRY DATE [MM/DD/YYYY]</Text>
          <TextInput
            style={styles.input}
            placeholder="Rotavirus Diluent expiring date. Format: MM/DD/YYYY"
        ...
        <View>
        <Text style={styles.label}>ROTAVIRUS 0.05ML SYRINGE BATCH NUMBER</Text>
        <TextInput
              style={styles.input}
              placeholder="Enter Rotavirus Syringe 0.05ml batch number"
        ...
        <View>
          <Text style={styles.label}>ROTAVIRUS 0.05ML SYRINGE EXPIRY DATE [MM/DD/YYYY]</Text>
          <TextInput
            style={styles.input}
            placeholder="Enter Rotavirus Syringe 0.05ml expiring date. Format: MM/DD/YYYY"
        ...
        <View>
        <Text style={styles.label}>ROTAVIRUS 2ML SYRINGE BATCH NUMBER</Text>
        <TextInput
              style={styles.input}
              placeholder="Enter Rotavirus 2ml Syringe batch number"
        ...
        <View>
          <Text style={styles.label}>ROTAVIRUS 2ML SYRINGE EXPIRY DATE [MM/DD/YYYY]</Text>
          <TextInput
            style={styles.input}
            placeholder="Rotavirus Syringe 2ml expiring date. Format: MM/DD/YYYY"
...
<View style={styles.questionaireContainer}>
          <ThemedText style={styles.subHeading}>ROTAVIRUS VACCINE TEMP AT PICK-UP</ThemedText>
  ...
  <View style={styles.questionaireContainer}>
    ...
    >
      ...
      <Picker.Item label="above 2 hrs" value="above 2 hrs" />
        ...
        <View  style={styles.questionaireContainer}>
          <ThemedText style={styles.subHeading}>ROTAVIRUS VACCINE VVM STAGE AT PICKUP </ThemedText>
          <View style={styles.ageGradeContainer}>
        ...
        <View>
        <Text style={styles.label}>ROTAVIRUS VACCINE OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text>
        <TextInput
              style={styles.input}
              placeholder="Enter Rotavirus Vaccine opening balance"
        ...
        <View  style={styles.calc}>
          <ThemedText style={styles.subHeading}>ROTAVIRUS VACCINE OPENING BALANCE IN AMPOULES :</ThemedText>
          {openingBalance && (
        ...
        <View>
        <Text style={styles.label}>ROTAVIRUS DILUENT OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text>
        <TextInput
              style={styles.input}
              placeholder="Enter Rotavirus Diluent opening balance"
        ...
        <View  style={styles.calc}>
          <ThemedText style={styles.subHeading}>ROTAVIRUS DILUENT OPENING BALANCE IN AMPOULES :</ThemedText>
          {diluentOpeningBalance && (
        ...
        <View  style={styles.calc}>
          <ThemedText style={styles.subHeading}>ROTAVIRUS DILUENT MISMATCH :</ThemedText>
          {diluentMismatch && (
            <>
              <ThemedText style={styles.mismatch}>
                {diluentMismatch} 
        ...
        <View>
        <Text style={styles.label}>ROTAVIRUS 0.05ML SYRINGE OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
        <TextInput
              style={styles.input}
              placeholder="Enter Rotavirus 0.05ml syringe opening balance"
        ...
        <View  style={styles.calc}>
          <ThemedText style={styles.subHeading}>ROTAVIRUS SYRINGE 0.05ML MISMATCH :</ThemedText>
          {syringe5mismatch && (
        ...
        <View>
        <Text style={styles.label}>ROTAVIRUS 2ML SYRINGE OPENING BALANCE </Text> 
        <TextInput
              style={styles.input}
              placeholder="Enter Rotavirus 2ml syringe opening balance"
        ...
        <View  style={styles.calc}>
        <ThemedText style={styles.subHeading}>ROTAVIRUS SYRINGE 2ML MISMATCH :</ThemedText>
          {syringe2mismatch && (
              <ThemedText style={styles.mismatch}>
        ...
        <View>
        <Text style={styles.label}>ROTAVIRUS VACCINE AVERAGE MONTHLY REQUIREMENT  (AMR) (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
        <TextInput
            style={styles.input}
            placeholder="Enter Rotavirus Vaccine average monthly requirement"
        ...
        <ThemedText style={styles.subHeading}>MMSQ MULTIPLICATION FACTOR:</ThemedText>
          ...
          <ThemedText style={styles.subHeading}>ROTAVIRUS VACCINE MONTHLY MAXIMUM STOCK QUANTITY:</ThemedText>
        ...
        <View style={styles.calc}>
          <ThemedText style={styles.subHeading}>
            ROTAVIRUS VACCINE DOSES REQUIRED TO MAKE UP TO MAXIMUM STOCK:
          </ThemedText>
          {dosesToIssueUp && (
            <ThemedText style={styles.mismatch}>
        ...
        <View>
        <Text style={styles.label}>ACTUAL ROTAVIRUS VACCINE DOSES ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
        <TextInput
          style={styles.input}
          placeholder="Rotavirus vaccine doses issued "
        ...
        <View style={styles.calc}>
          <ThemedText style={styles.subHeading}>
          Total Rotavirus vaccine available:
          </ThemedText>
          {vaccineTotal && (
            <ThemedText style={styles.mismatch}>
        ...
        <View style={styles.calc}>
          <ThemedText style={styles.subHeading}>
         QUANTITY (DOSES) OF DILUENT REQUIRED TO MATCH TOTAL AVAILABLE ROTAVIRUS VACCINE (FACTORING IN OPENING BALANCE):
         </ThemedText>
        </View>
        <ThemedText>
          {vaccineTotal && (
        ...
        <View>
        <Text style={styles.label}>ACTUAL QUANTITY (DOSES) OF ROTAVIRUS DILUENT ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
        <TextInput
          style={styles.input}
          placeholder="Rotavirus diluent issued "
          value={diluentIssued}
        ...
        <View style={styles.calc}>
          <ThemedText style={styles.subHeading}>
          QUANTITY OF 0.05ML SYRINGE REQUIRED TO MATCH TOTAL ROTAVIRUS VACCINE AVAILABLE (FACTORING IN OPENING BALANCE):
          </ThemedText>
          {vaccineTotal && (
            <ThemedText style={styles.mismatch}>
              {vaccine5requiredToMatchROTAAvail} pcs
            </ThemedText>
          )}
        </View>

        <View>
        <Text style={styles.label}>ACTUAL ROTAVIRUS 0.05ML SYRINGE QUANTITY ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
      <TextInput
          style={styles.input}
          placeholder="Rotavirus 0.05ml syringe Quantity Issued "
        ...
        <View style={styles.calc}>
          <ThemedText style={styles.subHeading}>
          QUANTITY OF 2ML SYRINGE REQUIRED TO MATCH TOTAL ROTAVIRUS VACCINE AVAILABLE (FACTORING IN OPENING BALANCE):
          </ThemedText>
          {vaccineTotal && (
            <ThemedText style={styles.mismatch}>
        ...
        <View>
        <Text style={styles.label}>ACTUAL ROTAVIRUS 2ML SYRINGE QUANTITY ISSUED </Text> 
        <TextInput
            style={styles.input}
            placeholder="Rotavirus 2ml syringe Quantity Issued "
  ...
  <View style={styles.questionaireContainer}>
          <ThemedText style={styles.subHeading}>Rotavirus VACCINE TEMP AT ISSUE</ThemedText>
          <View style={styles.ageGradeContainer}>
      ...
      <View  style={styles.questionaireContainer}>
        ...
        <ThemedText style={styles.subHeading}>ROTAVIRUS VACCINE VVM STAGE AT ISSUE</ThemedText>
          <View style={styles.ageGradeContainer}>
      ...
      <TouchableOpacity onPress={handleGenerateFields} style={styles.buttonfill}>
        <Text style={styles.buttonText}>
          Fill another Rotavirus Logistics form for a different manufacturer
        </Text>
      </TouchableOpacity>
        ...
        <TextInput
              style={styles.input}
              placeholder="Rotavirus Vaccine batch number"
              value={batchNumbera}
        ...
        <TextInput
              style={styles.input}
              placeholder="Rotavirus Vaccine expiring date.     Format: January 7, 2019"
              value={expiryDatea}
        ...
        <TextInput
              style={styles.input}
              placeholder="Rotavirus Vaccine opening balance"
...
<View style={styles.questionaireContainer}>
          <ThemedText style={styles.subHeading}>Rotavirus Vaccine temp at pickup </ThemedText>
          <View style={styles.ageGradeContainer}>
        ...
        <TextInput
              style={styles.input}
              placeholder="Rotavirus Diluent batch number"
              value={diluentBatchNumber}
              onChangeText={setDiluentBatchNumber}
            />
        ...
        <TextInput
              style={styles.input}
              placeholder="Rotavirus Diluent expiring date.     Format: MM/DD/YY 01/17/2019"
              value={diluentExpiryDate}
        ...
        <TextInput
              style={styles.input}
              placeholder="Rotavirus Diluent opening balance"
              value={diluentOpeningBalancea}
              onChangeText={setDiluentOpeningBalancea}
            />
        <View  style={styles.questionaireContainer}>
        <ThemedText style={styles.subHeading}>Rotavirus Diluent mismatch adjustment: {}</ThemedText>
        </View>

        
        <TextInput
              style={styles.input}
              placeholder="Rotavirus 0.05ml syringe opening balance"
              value={syringeOpeningBalance}
              onChangeText={setSyringeOpeningBalance}
            />
        ...
        <TextInput
              style={styles.input}
              placeholder="Rotavirus 2ml syringe opening balance"
              value={mlsyringeOpeningBalance}
              onChangeText={setMlsyringeOpeningBalance}
            />
        ...
        <TextInput
            style={styles.input}
            placeholder="Rotavirus Vaccine average monthly requirement"
            value={averageMonthlyRequirement}
            onChangeText={setAverageMonthlyRequirement}
          /> 
        ...
        <TextInput
            style={styles.input}
            placeholder="Rotavirus vaccine maximum stock quantity"
            value={maximumStock}
        ...
        <TextInput
          style={styles.input}
          placeholder="Rotavirus vaccine doses to issue up to monthly MSQ"
