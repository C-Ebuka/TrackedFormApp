...
export default function BOPVScreen() {
  ...
  const [showAlertBOP, setShowAlertBOP] = useState(false);
  ...
  const [totalBOPDiluentAvailable, setTotalBOPDiluentAvailable] = useState('');
  const [vaccine5requiredToMatchBopAvail, setVaccine5requiredToMatchBopAvail] = useState('');
...
const handleBOPDateChange = (text: string) => {
  setExpiryDate(text);
  const validityMessage: string = isValidDate(text); // Ensure validityMessage is typed as string
  setShowAlertBOP(validityMessage !== 'valid' && text.trim().length > 0);
};
...
const navigateForward = () => {
  ...
  useEffect(() => {
    ...
    if (openingBalance && diluentOpeningBalance) {
      const bOPOpening = parseInt(openingBalance);
      const diluentOpening = parseInt(diluentOpeningBalance);
      const diluentMismatchAdjustment = bOPOpening - diluentOpening;
    ...
    if (vaccineTotal && syringeOpeningBalance) {
      const vaccine5requiredToMatchBOPAvailCalc = parseInt(vaccineTotal) - (Number(syringeOpeningBalance));
      setVaccine5requiredToMatchBopAvail(vaccine5requiredToMatchBOPAvailCalc.toString()); 
    }
   
    if (diluentOpeningBalance && diluentIssued ) {
      const totalBOPDiluentAvailableCalc =  (parseInt(diluentOpeningBalance) + parseInt(diluentIssued));
      setTotalBOPDiluentAvailable(totalBOPDiluentAvailableCalc.toString());

    }
    
    if (diluentOpeningBalance && vaccineTotal && diluentIssued && totalBOPDiluentAvailable) {
      const dilAvailableMismatchCalc = parseInt(vaccineTotal) - (parseInt(totalBOPDiluentAvailable));
  ...
  return (
    <ParallaxScrollView
      ...
      <ThemedView style={styles.formContainer}>
        ...
        <ThemedText style={styles.header}>BOP LOGISTICS DATA</ThemedText>
        ...
        <View>
        <Text style={styles.label}>BOP VACCINE BATCH NUMBER</Text>
        <TextInput
              style={styles.input}
              placeholder="Enter BOP Vaccine batch number"
              value={batchNumber}
        ...
        <View>
          <Text style={styles.label}>BOP VACCINE EXPIRY DATE [MM/DD/YYYY]</Text>
          <TextInput
            style={styles.input}
            placeholder="Enter BOP Vaccine expiring date. Format: MM/DD/YYYY"
            value={expiryDate}
            onChangeText={handleBOPDateChange}
          />
          {showAlertBOP && (
        ...
        <View>
        <Text style={styles.label}>BOP DILUENT BATCH NUMBER</Text>
        <TextInput
              style={styles.input}
              placeholder="Enter BOP Diluent batch number"
        ...
        <View>
          <Text style={styles.label}>BOP DILUENT EXPIRY DATE [MM/DD/YYYY]</Text>
          <TextInput
            style={styles.input}
            placeholder="BOP Diluent expiring date. Format: MM/DD/YYYY"
        ...
        <View>
        <Text style={styles.label}>BOP 0.05ML SYRINGE BATCH NUMBER</Text>
        <TextInput
              style={styles.input}
              placeholder="Enter BOP Syringe 0.05ml batch number"
        ...
        <View>
          <Text style={styles.label}>BOP 0.05ML SYRINGE EXPIRY DATE [MM/DD/YYYY]</Text>
          <TextInput
            style={styles.input}
            placeholder="Enter BOP Syringe 0.05ml expiring date. Format: MM/DD/YYYY"
        ...
        <View>
        <Text style={styles.label}>BOP 2ML SYRINGE BATCH NUMBER</Text>
        <TextInput
              style={styles.input}
              placeholder="Enter BOP 2ml Syringe batch number"
        ...
        <View>
          <Text style={styles.label}>BOP 2ML SYRINGE EXPIRY DATE [MM/DD/YYYY]</Text>
          <TextInput
            style={styles.input}
            placeholder="BOP Syringe 2ml expiring date. Format: MM/DD/YYYY"
...
<View style={styles.questionaireContainer}>
          <ThemedText style={styles.subHeading}>BOP VACCINE TEMP AT PICK-UP</ThemedText>
  ...
  <View style={styles.questionaireContainer}>
    ...
    >
      ...
      <Picker.Item label="above 2 hrs" value="above 2 hrs" />
        ...
        <View  style={styles.questionaireContainer}>
          <ThemedText style={styles.subHeading}>BOP VACCINE VVM STAGE AT PICKUP </ThemedText>
          <View style={styles.ageGradeContainer}>
        ...
        <View>
        <Text style={styles.label}>BOP VACCINE OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text>
        <TextInput
              style={styles.input}
              placeholder="Enter BOP Vaccine opening balance"
        ...
        <View  style={styles.calc}>
          <ThemedText style={styles.subHeading}>BOP VACCINE OPENING BALANCE IN AMPOULES :</ThemedText>
          {openingBalance && (
        ...
        <View>
        <Text style={styles.label}>BOP DILUENT OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text>
        <TextInput
              style={styles.input}
              placeholder="Enter BOP Diluent opening balance"
        ...
        <View  style={styles.calc}>
          <ThemedText style={styles.subHeading}>BOP DILUENT OPENING BALANCE IN AMPOULES :</ThemedText>
          {diluentOpeningBalance && (
        ...
        <View  style={styles.calc}>
          <ThemedText style={styles.subHeading}>BOP DILUENT MISMATCH :</ThemedText>
          {diluentMismatch && (
            <>
              <ThemedText style={styles.mismatch}>
                {diluentMismatch} 
        ...
        <View>
        <Text style={styles.label}>BOP 0.05ML SYRINGE OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
        <TextInput
              style={styles.input}
              placeholder="Enter BOP 0.05ml syringe opening balance"
        ...
        <View  style={styles.calc}>
          <ThemedText style={styles.subHeading}>BOP SYRINGE 0.05ML MISMATCH :</ThemedText>
          {syringe5mismatch && (
        ...
        <View>
        <Text style={styles.label}>BOP 2ML SYRINGE OPENING BALANCE </Text> 
        <TextInput
              style={styles.input}
              placeholder="Enter BOP 2ml syringe opening balance"
        ...
        <View  style={styles.calc}>
        <ThemedText style={styles.subHeading}>BOP SYRINGE 2ML MISMATCH :</ThemedText>
          {syringe2mismatch && (
              <ThemedText style={styles.mismatch}>
        ...
        <View>
        <Text style={styles.label}>BOP VACCINE AVERAGE MONTHLY REQUIREMENT  (AMR) (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
        <TextInput
            style={styles.input}
            placeholder="Enter BOP Vaccine average monthly requirement"
        ...
        <ThemedText style={styles.subHeading}>MMSQ MULTIPLICATION FACTOR:</ThemedText>
          ...
          <ThemedText style={styles.subHeading}>BOP VACCINE MONTHLY MAXIMUM STOCK QUANTITY:</ThemedText>
        ...
        <View style={styles.calc}>
          ...
          BOP VACCINE DOSES REQUIRED TO MAKE UP TO MAXIMUM STOCK:
          </ThemedText>
          {dosesToIssueUp && (
            <ThemedText style={styles.mismatch}>
        ...
        <View>
        <Text style={styles.label}>ACTUAL BOP VACCINE DOSES ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
        <TextInput
          style={styles.input}
          placeholder="BOP vaccine doses issued "
        ...
        <View style={styles.calc}>
          <ThemedText style={styles.subHeading}>
         QUANTITY (DOSES) OF DILUENT REQUIRED TO MATCH TOTAL AVAILABLE BOP VACCINE (FACTORING IN OPENING BALANCE):
         </ThemedText>
        </View>
        <ThemedText>
          {vaccineTotal && (
        ...
        <View>
        <Text style={styles.label}>ACTUAL QUANTITY (DOSES) OF BOP DILUENT ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
        <TextInput
          style={styles.input}
          placeholder="BOP diluent issued "
          value={diluentIssued}
        ...
        <View style={styles.calc}>
          <ThemedText style={styles.subHeading}>
          QUANTITY OF 0.05ML SYRINGE REQUIRED TO MATCH TOTAL BOP VACCINE AVAILABLE (FACTORING IN OPENING BALANCE):
          </ThemedText>
          {vaccineTotal && (
            <ThemedText style={styles.mismatch}>
              {vaccine5requiredToMatchBopAvail} pcs
            </ThemedText>
          )}
        </View>

        <View>
        <Text style={styles.label}>ACTUAL BOP 0.05ML SYRINGE QUANTITY ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
      <TextInput
          style={styles.input}
          placeholder="BOP 0.05ml syringe Quantity Issued "
        ...
        <View style={styles.calc}>
          <ThemedText style={styles.subHeading}>
          QUANTITY OF 2ML SYRINGE REQUIRED TO MATCH TOTAL BOP VACCINE AVAILABLE (FACTORING IN OPENING BALANCE):
          </ThemedText>
          {vaccineTotal && (
            <ThemedText style={styles.mismatch}>
        ...
        <View>
        <Text style={styles.label}>ACTUAL BOP 2ML SYRINGE QUANTITY ISSUED </Text> 
        <TextInput
            style={styles.input}
            placeholder="BOP 2ml syringe Quantity Issued "
  ...
  <View style={styles.questionaireContainer}>
          <ThemedText style={styles.subHeading}>BOP VACCINE TEMP AT ISSUE</ThemedText>
          <View style={styles.ageGradeContainer}>
      ...
      <View  style={styles.questionaireContainer}>
        ...
        <ThemedText style={styles.subHeading}>BOP VACCINE VVM STAGE AT ISSUE</ThemedText>
          <View style={styles.ageGradeContainer}>
      ...
      <TouchableOpacity onPress={handleGenerateFields} style={styles.buttonfill}>
        <Text style={styles.buttonText}>
          Fill another BOP Logistics form for a different manufacturer
        </Text>
      </TouchableOpacity>
        ...
        <TextInput
              style={styles.input}
              placeholder="BOP Vaccine batch number"
              value={batchNumbera}
        ...
        <TextInput
              style={styles.input}
              placeholder="BOP Vaccine expiring date.     Format: January 7, 2019"
              value={expiryDatea}
        ...
        <TextInput
              style={styles.input}
              placeholder="BOP Vaccine opening balance"
...
<View style={styles.questionaireContainer}>
          <ThemedText style={styles.subHeading}>BOP Vaccine temp at pickup </ThemedText>
          <View style={styles.ageGradeContainer}>
        ...
        <TextInput
              style={styles.input}
              placeholder="BOP Diluent batch number"
              value={diluentBatchNumber}
              onChangeText={setDiluentBatchNumber}
            />
        ...
        <TextInput
              style={styles.input}
              placeholder="BOP Diluent expiring date.     Format: MM/DD/YY 01/17/2019"
              value={diluentExpiryDate}
        ...
        <TextInput
              style={styles.input}
              placeholder="BOP Diluent opening balance"
              value={diluentOpeningBalancea}
              onChangeText={setDiluentOpeningBalancea}
            />
        <View  style={styles.questionaireContainer}>
        <ThemedText style={styles.subHeading}>BOP Diluent mismatch adjustment: {}</ThemedText>
        </View>

        
        <TextInput
              style={styles.input}
              placeholder="BOP 0.05ml syringe opening balance"
              value={syringeOpeningBalance}
              onChangeText={setSyringeOpeningBalance}
            />
        ...
        <TextInput
              style={styles.input}
              placeholder="BOP 2ml syringe opening balance"
              value={mlsyringeOpeningBalance}
              onChangeText={setMlsyringeOpeningBalance}
            />
        ...
        <TextInput
            style={styles.input}
            placeholder="BOP Vaccine average monthly requirement"
            value={averageMonthlyRequirement}
            onChangeText={setAverageMonthlyRequirement}
          /> 
        ...
        <TextInput
            style={styles.input}
            placeholder="BOP vaccine maximum stock quantity"
            value={maximumStock}
        ...
        <TextInput
          style={styles.input}
          placeholder="BOP vaccine doses to issue up to monthly MSQ"
