...
export default function PCVScreen() {
  ...
  const [showAlertPCV, setShowAlertPCV] = useState(false);
  ...
  const [totalPCVDiluentAvailable, setTotalPCVDiluentAvailable] = useState('');
  const [vaccine5requiredToMatchPCVAvail, setVaccine5requiredToMatchPCVAvail] = useState('');
...
const handlePCVDateChange = (text: string) => {
  setExpiryDate(text);
  const validityMessage: string = isValidDate(text); // Ensure validityMessage is typed as string
  setShowAlertPCV(validityMessage !== 'valid' && text.trim().length > 0);
};
...
const navigateBackward = () => {
    navigation.navigate('IPVScreen'); // Navigate back to the previous screen, which is 'Home'
  };
  ...
  useEffect(() => {
    ...
    if (openingBalance && diluentOpeningBalance) {
      const PCVOpening = parseInt(openingBalance);
      const diluentOpening = parseInt(diluentOpeningBalance);
      const diluentMismatchAdjustment = PCVOpening - diluentOpening;
    ...
    if (vaccineTotal && syringeOpeningBalance) {
      const vaccine5requiredToMatchPCVAvailCalc = parseInt(vaccineTotal) - (Number(syringeOpeningBalance));
      setVaccine5requiredToMatchPCVAvail(vaccine5requiredToMatchPCVAvailCalc.toString()); 
    }
   
    if (diluentOpeningBalance && diluentIssued ) {
      const totalPCVDiluentAvailableCalc =  (parseInt(diluentOpeningBalance) + parseInt(diluentIssued));
      setTotalPCVDiluentAvailable(totalPCVDiluentAvailableCalc.toString());

    }
    
    if (diluentOpeningBalance && vaccineTotal && diluentIssued && totalPCVDiluentAvailable) {
      const dilAvailableMismatchCalc = parseInt(vaccineTotal) - (parseInt(totalPCVDiluentAvailable));
  ...
  return (
    <ParallaxScrollView
      ...
      <ThemedView style={styles.formContainer}>
        ...
        <ThemedText style={styles.header}> PNEUMOCOCCAL CONJUGATE VACCINE LOGISTICS DATA</ThemedText>
...
<View>
<Text style={styles.label}>PNEUMOCOCCAL CONJUGATE VACCINE VACCINE BATCH NUMBER</Text>
<TextInput
      style={styles.input}
      placeholder="Enter PCV Vaccine batch number"
      value={batchNumber}
...
<View>
  <Text style={styles.label}>PNEUMOCOCCAL CONJUGATE VACCINE VACCINE EXPIRY DATE [MM/DD/YYYY]</Text>
  <TextInput
    style={styles.input}
    placeholder="Enter PCV Vaccine expiring date. Format: MM/DD/YYYY"
    value={expiryDate}
    onChangeText={handlePCVDateChange}
  />
  {showAlertPCV && (
...
<View>
<Text style={styles.label}>PNEUMOCOCCAL CONJUGATE VACCINE DILUENT BATCH NUMBER</Text>
<TextInput
      style={styles.input}
      placeholder="Enter PCV Diluent batch number"
...
<View>
  <Text style={styles.label}>PNEUMOCOCCAL CONJUGATE VACCINE DILUENT EXPIRY DATE [MM/DD/YYYY]</Text>
  <TextInput
    style={styles.input}
    placeholder="PCV Diluent expiring date. Format: MM/DD/YYYY"
...
<View>
<Text style={styles.label}>PNEUMOCOCCAL CONJUGATE VACCINE 0.05ML SYRINGE BATCH NUMBER</Text>
<TextInput
      style={styles.input}
      placeholder="Enter PCV Syringe 0.05ml batch number"
...
<View>
  <Text style={styles.label}>PNEUMOCOCCAL CONJUGATE VACCINE 0.05ML SYRINGE EXPIRY DATE [MM/DD/YYYY]</Text>
  <TextInput
    style={styles.input}
    placeholder="Enter PCV Syringe 0.05ml expiring date. Format: MM/DD/YYYY"
...
<View>
<Text style={styles.label}>PNEUMOCOCCAL CONJUGATE VACCINE 2ML SYRINGE BATCH NUMBER</Text>
<TextInput
      style={styles.input}
      placeholder="Enter PCV 2ml Syringe batch number"
...
<View>
  <Text style={styles.label}>PNEUMOCOCCAL CONJUGATE VACCINE 2ML SYRINGE EXPIRY DATE [MM/DD/YYYY]</Text>
  <TextInput
    style={styles.input}
    placeholder="PCV Syringe 2ml expiring date. Format: MM/DD/YYYY"
...
<View style={styles.questionaireContainer}>
  <ThemedText style={styles.subHeading}>PNEUMOCOCCAL CONJUGATE VACCINE VACCINE TEMP AT PICK-UP</ThemedText>
...
<View  style={styles.questionaireContainer}>
  <ThemedText style={styles.subHeading}>PNEUMOCOCCAL CONJUGATE VACCINE VACCINE VVM STAGE AT PICKUP </ThemedText>
  <View style={styles.ageGradeContainer}>
...
<View>
<Text style={styles.label}>PNEUMOCOCCAL CONJUGATE VACCINE VACCINE OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text>
<TextInput
      style={styles.input}
      placeholder="Enter PCV Vaccine opening balance"
...
<View  style={styles.calc}>
  <ThemedText style={styles.subHeading}>PNEUMOCOCCAL CONJUGATE VACCINE VACCINE OPENING BALANCE IN AMPOULES :</ThemedText>
  {openingBalance && (
...
<View>
<Text style={styles.label}>PNEUMOCOCCAL CONJUGATE VACCINE DILUENT OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text>
<TextInput
      style={styles.input}
      placeholder="Enter PCV Diluent opening balance"
...
<View  style={styles.calc}>
  <ThemedText style={styles.subHeading}>PCV DILUENT OPENING BALANCE IN AMPOULES :</ThemedText>
  {diluentOpeningBalance && (
...
<View  style={styles.calc}>
  <ThemedText style={styles.subHeading}>PCV DILUENT MISMATCH :</ThemedText>
  {diluentMismatch && (
    <>
      <ThemedText style={styles.mismatch}>
        {diluentMismatch} 
      ...
      <ThemedText>
        PCV DILUENT MISMATCH IN AMPOULES:
      </ThemedText>
      <ThemedText style={styles.mismatch}>            
...
<View>
<Text style={styles.label}>PCV 0.05ML SYRINGE OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
<TextInput
      style={styles.input}
      placeholder="Enter PCV 0.05ml syringe opening balance"
...
<View  style={styles.calc}>
  <ThemedText style={styles.subHeading}>PCV SYRINGE 0.05ML MISMATCH :</ThemedText>
  {syringe5mismatch && (
...
<View>
<Text style={styles.label}>PCV 2ML SYRINGE OPENING BALANCE </Text> 
<TextInput
      style={styles.input}
      placeholder="Enter PCV 2ml syringe opening balance"
...
<View  style={styles.calc}>
<ThemedText style={styles.subHeading}>PCV SYRINGE 2ML MISMATCH :</ThemedText>
  {syringe2mismatch && (
      <ThemedText style={styles.mismatch}>
...
<View>
<Text style={styles.label}>PCV VACCINE AVERAGE MONTHLY REQUIREMENT  (AMR) (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
<TextInput
    style={styles.input}
    placeholder="Enter PCV Vaccine average monthly requirement"
...
<ThemedText style={styles.subHeading}>MMSQ MULTIPLICATION FACTOR:</ThemedText>
  ...
  <ThemedText style={styles.subHeading}>PCV VACCINE MONTHLY MAXIMUM STOCK QUANTITY:</ThemedText>
...
<View style={styles.calc}>
  <ThemedText style={styles.subHeading}>
    PCV VACCINE DOSES REQUIRED TO MAKE UP TO MAXIMUM STOCK:
  </ThemedText>
  {dosesToIssueUp && (
    <ThemedText style={styles.mismatch}>
...
<View>
<Text style={styles.label}>ACTUAL PCV VACCINE DOSES ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
<TextInput
  style={styles.input}
  placeholder="PCV vaccine doses issued "
...
<View style={styles.calc}>
  <ThemedText style={styles.subHeading}>
 QUANTITY (DOSES) OF DILUENT REQUIRED TO MATCH TOTAL AVAILABLE PCV VACCINE (FACTORING IN OPENING BALANCE):
 </ThemedText>
</View>
<ThemedText>
  {vaccineTotal && (
...
<View>
<Text style={styles.label}>ACTUAL QUANTITY (DOSES) OF PCV DILUENT ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
<TextInput
  style={styles.input}
  placeholder="PCV diluent issued "
  value={diluentIssued}
...
<View style={styles.calc}>
  <ThemedText style={styles.subHeading}>
  QUANTITY OF 0.05ML PCV SYRINGE REQUIRED TO MATCH TOTAL PCV VACCINE AVAILABLE (FACTORING IN OPENING BALANCE):
  </ThemedText>
  {vaccineTotal && (
    <ThemedText style={styles.mismatch}>
      {vaccine5requiredToMatchPCVAvail} pcs
    </ThemedText>
  )}
</View>

<View>
<Text style={styles.label}>ACTUAL PCV 0.05ML SYRINGE QUANTITY ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
<TextInput
  style={styles.input}
  placeholder="PCV 0.05ml syringe Quantity Issued "
...
<View style={styles.calc}>
  <ThemedText style={styles.subHeading}>
  QUANTITY OF 2ML SYRINGE REQUIRED TO MATCH TOTAL PCV VACCINE AVAILABLE (FACTORING IN OPENING BALANCE):
  </ThemedText>
  {vaccineTotal && (
    <ThemedText style={styles.mismatch}>
...
<View>
<Text style={styles.label}>ACTUAL PCV 2ML SYRINGE QUANTITY ISSUED </Text> 
<TextInput
    style={styles.input}
    placeholder="PCV 2ml syringe Quantity Issued "
...
<View style={styles.questionaireContainer}>
  <ThemedText style={styles.subHeading}>PCV VACCINE TEMP AT ISSUE</ThemedText>
  <View style={styles.ageGradeContainer}>
...
<ThemedText style={styles.subHeading}>PCV VACCINE VVM STAGE AT ISSUE</ThemedText>
  <View style={styles.ageGradeContainer}>
...
<Text style={styles.buttonText}>
  Fill another PCV Logistics form for a different manufacturer
</Text>
</TouchableOpacity>
...
<TextInput
      style={styles.input}
      placeholder="PCV Vaccine batch number"
      value={batchNumbera}
...
<TextInput
      style={styles.input}
      placeholder="PCV Vaccine expiring date.     Format: January 7, 2019"
      value={expiryDatea}
...
<TextInput
      style={styles.input}
      placeholder="PCV Vaccine opening balance"
...
<View style={styles.questionaireContainer}>
  <ThemedText style={styles.subHeading}>PCV Vaccine temp at pickup </ThemedText>
  <View style={styles.ageGradeContainer}>
...
<View  style={styles.questionaireContainer}>
  <ThemedText style={styles.subHeading}>PCV Vaccine VVM stage at pickup </ThemedText>
  <View style={styles.ageGradeContainer}>
...
<TextInput
      style={styles.input}
      placeholder="PCV Diluent batch number"
      value={diluentBatchNumber}
      onChangeText={setDiluentBatchNumber}
    />
...
<TextInput
      style={styles.input}
      placeholder="PCV Diluent expiring date.     Format: MM/DD/YY 01/17/2019"
      value={diluentExpiryDate}
...
<TextInput
      style={styles.input}
      placeholder="PCV Diluent opening balance"
      value={diluentOpeningBalancea}
      onChangeText={setDiluentOpeningBalancea}
    />
<View  style={styles.questionaireContainer}>
<ThemedText style={styles.subHeading}>PCV Diluent mismatch adjustment: {}</ThemedText>
</View>


<TextInput
      style={styles.input}
      placeholder="PCV 0.05ml syringe opening balance"
      value={syringeOpeningBalance}
      onChangeText={setSyringeOpeningBalance}
    />
...
<TextInput
      style={styles.input}
      placeholder="PCV 2ml syringe opening balance"
      value={mlsyringeOpeningBalance}
      onChangeText={setMlsyringeOpeningBalance}
    />
...
<TextInput
    style={styles.input}
    placeholder="PCV Vaccine average monthly requirement"
    value={averageMonthlyRequirement}
    onChangeText={setAverageMonthlyRequirement}
  /> 
...
<TextInput
    style={styles.input}
    placeholder="PCV vaccine maximum stock quantity"
    value={maximumStock}
...
<TextInput
  style={styles.input}
  placeholder="PCV vaccine doses to issue up to monthly MSQ"
...
{generateFields1 && (
  ...
  <>
    ...
    <Text style={styles.header}>
    PNEUMOCOCCAL CONJUGATE VACCINE LOGISTICS DATA
