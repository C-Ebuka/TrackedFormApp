...
export default function HepBScreen() {
  ...
  const [showAlertHEPB, setShowAlertHEPB] = useState(false);
  ...
  const [totalHepBDiluentAvailable, setTotalHepBDiluentAvailable] = useState('');
  const [vaccine5requiredToMatchHepBAvail, setVaccine5requiredToMatchHepBAvail] = useState('');
...
const handleHEPBDateChange = (text: string) => {
  setExpiryDate(text);
  const validityMessage: string = isValidDate(text); // Ensure validityMessage is typed as string
  setShowAlertHEPB(validityMessage !== 'valid' && text.trim().length > 0);
};
...
const navigateForward = () => {
  ...
  useEffect(() => {
    ...
    if (openingBalance && diluentOpeningBalance) {
      const HepBOpening = parseInt(openingBalance);
      const diluentOpening = parseInt(diluentOpeningBalance);
      const diluentMismatchAdjustment = HepBOpening - diluentOpening;
    ...
    if (vaccineTotal && syringeOpeningBalance) {
      const vaccine5requiredToMatchHepBAvailCalc = parseInt(vaccineTotal) - (Number(syringeOpeningBalance));
      setVaccine5requiredToMatchHepBAvail(vaccine5requiredToMatchHepBAvailCalc.toString()); 
    }
   
    if (diluentOpeningBalance && diluentIssued ) {
      const totalHepBDiluentAvailableCalc =  (parseInt(diluentOpeningBalance) + parseInt(diluentIssued));
      setTotalHepBDiluentAvailable(totalHepBDiluentAvailableCalc.toString());

    }
    
    if (diluentOpeningBalance && vaccineTotal && diluentIssued && totalHepBDiluentAvailable) {
      const dilAvailableMismatchCalc = parseInt(vaccineTotal) - (parseInt(totalHepBDiluentAvailable));
  ...
  return (
    <ParallaxScrollView
      ...
      <ThemedView style={styles.formContainer}>
        ...
        <ThemedText style={styles.header}>HEPATITIS B LOGISTICS DATA</ThemedText>
...
<View>
<Text style={styles.label}>HEPATITIS B VACCINE BATCH NUMBER</Text>
<TextInput
      style={styles.input}
      placeholder="Enter Hepatitis B Vaccine batch number"
      value={batchNumber}
...
<View>
  <Text style={styles.label}>HEPATITIS B VACCINE EXPIRY DATE [MM/DD/YYYY]</Text>
  <TextInput
    style={styles.input}
    placeholder="Enter Hepatitis B Vaccine expiring date. Format: MM/DD/YYYY"
    value={expiryDate}
    onChangeText={handleHEPBDateChange}
  />
  {showAlertHEPB && (
...
<View>
<Text style={styles.label}>HEPATITIS B DILUENT BATCH NUMBER</Text>
<TextInput
      style={styles.input}
      placeholder="Enter Hepatitis B Diluent batch number"
...
<View>
  <Text style={styles.label}>HEPATITIS B DILUENT EXPIRY DATE [MM/DD/YYYY]</Text>
  <TextInput
    style={styles.input}
    placeholder="Hepatitis B Diluent expiring date. Format: MM/DD/YYYY"
...
<View>
<Text style={styles.label}>HEPATITIS B 0.05ML SYRINGE BATCH NUMBER</Text>
<TextInput
      style={styles.input}
      placeholder="Enter Hepatitis B Syringe 0.05ml batch number"
...
<View>
  <Text style={styles.label}>HEPATITIS B 0.05ML SYRINGE EXPIRY DATE [MM/DD/YYYY]</Text>
  <TextInput
    style={styles.input}
    placeholder="Enter Hepatitis B Syringe 0.05ml expiring date. Format: MM/DD/YYYY"
...
<View>
<Text style={styles.label}>HEPATITIS B 2ML SYRINGE BATCH NUMBER</Text>
<TextInput
      style={styles.input}
      placeholder="Enter Hepatitis B 2ml Syringe batch number"
...
<View>
  <Text style={styles.label}>HEPATITIS B 2ML SYRINGE EXPIRY DATE [MM/DD/YYYY]</Text>
  <TextInput
    style={styles.input}
    placeholder="Hepatitis B Syringe 2ml expiring date. Format: MM/DD/YYYY"
...
<View style={styles.questionaireContainer}>
  <ThemedText style={styles.subHeading}>HEPATITIS B VACCINE TEMP AT PICK-UP</ThemedText>
...
<View  style={styles.questionaireContainer}>
  <ThemedText style={styles.subHeading}>HEPATITIS B VACCINE VVM STAGE AT PICKUP </ThemedText>
  <View style={styles.ageGradeContainer}>
...
<View>
<Text style={styles.label}>HEPATITIS B VACCINE OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text>
<TextInput
      style={styles.input}
      placeholder="Enter Hepatitis B Vaccine opening balance"
...
<View  style={styles.calc}>
  <ThemedText style={styles.subHeading}>HEPATITIS B VACCINE OPENING BALANCE IN AMPOULES :</ThemedText>
  {openingBalance && (
...
<View>
<Text style={styles.label}>HEPATITIS B DILUENT OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text>
<TextInput
      style={styles.input}
      placeholder="Enter Hepatitis B Diluent opening balance"
...
<View  style={styles.calc}>
  <ThemedText style={styles.subHeading}>HEPATITIS B DILUENT OPENING BALANCE IN AMPOULES :</ThemedText>
  {diluentOpeningBalance && (
...
<View  style={styles.calc}>
  <ThemedText style={styles.subHeading}>HEPATITIS B DILUENT MISMATCH :</ThemedText>
  {diluentMismatch && (
    <>
      <ThemedText style={styles.mismatch}>
        {diluentMismatch} 
...
<View>
<Text style={styles.label}>HEPATITIS B 0.05ML SYRINGE OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
<TextInput
      style={styles.input}
      placeholder="Enter Hepatitis B 0.05ml syringe opening balance"
...
<View  style={styles.calc}>
  <ThemedText style={styles.subHeading}>HEPATITIS B SYRINGE 0.05ML MISMATCH :</ThemedText>
  {syringe5mismatch && (
...
<View>
<Text style={styles.label}>HEPATITIS B 2ML SYRINGE OPENING BALANCE </Text> 
<TextInput
      style={styles.input}
      placeholder="Enter Hepatitis B 2ml syringe opening balance"
...
<View  style={styles.calc}>
<ThemedText style={styles.subHeading}>HEPATITIS B SYRINGE 2ML MISMATCH :</ThemedText>
  {syringe2mismatch && (
      <ThemedText style={styles.mismatch}>
...
<View>
<Text style={styles.label}>HEPATITIS B VACCINE AVERAGE MONTHLY REQUIREMENT  (AMR) (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
<TextInput
    style={styles.input}
    placeholder="Enter Hepatitis B Vaccine average monthly requirement"
...
<ThemedText style={styles.subHeading}>MMSQ MULTIPLICATION FACTOR:</ThemedText>
  ...
  <ThemedText style={styles.subHeading}>HEPATITIS B VACCINE MONTHLY MAXIMUM STOCK QUANTITY:</ThemedText>
...
<View style={styles.calc}>
  <ThemedText style={styles.subHeading}>
    HEPATITIS B VACCINE DOSES REQUIRED TO MAKE UP TO MAXIMUM STOCK:
  </ThemedText>
  {dosesToIssueUp && (
    <ThemedText style={styles.mismatch}>
...
<View>
<Text style={styles.label}>ACTUAL HEPATITIS B VACCINE DOSES ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
<TextInput
  style={styles.input}
  placeholder="Hepatitis B vaccine doses issued "
...
<View style={styles.calc}>
  <ThemedText style={styles.subHeading}>
  Total HEPATITIS B vaccine available:
  </ThemedText>
  {vaccineTotal && (
    <ThemedText style={styles.mismatch}>
...
<View style={styles.calc}>
  <ThemedText style={styles.subHeading}>
 QUANTITY (DOSES) OF DILUENT REQUIRED TO MATCH TOTAL AVAILABLE HEPATITIS B VACCINE (FACTORING IN OPENING BALANCE):
 </ThemedText>
</View>
<ThemedText>
  {vaccineTotal && (
...
<View>
<Text style={styles.label}>ACTUAL QUANTITY (DOSES) OF HEPATITIS B DILUENT ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
<TextInput
  style={styles.input}
  placeholder="Hepatitis B diluent issued "
  value={diluentIssued}
...
<View style={styles.calc}>
  <ThemedText style={styles.subHeading}>
  QUANTITY OF 0.05ML SYRINGE REQUIRED TO MATCH TOTAL HEPATITIS B VACCINE AVAILABLE (FACTORING IN OPENING BALANCE):
  </ThemedText>
  {vaccineTotal && (
    <ThemedText style={styles.mismatch}>
      {vaccine5requiredToMatchHepBAvail} pcs
    </ThemedText>
  )}
</View>

<View>
<Text style={styles.label}>ACTUAL HEPATITIS B 0.05ML SYRINGE QUANTITY ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
<TextInput
  style={styles.input}
  placeholder="Hepatitis B 0.05ml syringe Quantity Issued "
...
<View style={styles.calc}>
  <ThemedText style={styles.subHeading}>
  QUANTITY OF 2ML SYRINGE REQUIRED TO MATCH TOTAL HEPATITIS B VACCINE AVAILABLE (FACTORING IN OPENING BALANCE):
  </ThemedText>
  {vaccineTotal && (
    <ThemedText style={styles.mismatch}>
...
<View>
<Text style={styles.label}>ACTUAL HEPATITIS B 2ML SYRINGE QUANTITY ISSUED </Text> 
<TextInput
    style={styles.input}
    placeholder="Hepatitis B 2ml syringe Quantity Issued "
...
<View style={styles.questionaireContainer}>
  <ThemedText style={styles.subHeading}>HEPATITIS B VACCINE TEMP AT ISSUE</ThemedText>
  <View style={styles.ageGradeContainer}>
...
<ThemedText style={styles.subHeading}>HEPATITIS B VACCINE VVM STAGE AT ISSUE</ThemedText>
  <View style={styles.ageGradeContainer}>
...
<Text style={styles.buttonText}>
  Fill another HEPATITIS B Logistics form for a different manufacturer
</Text>
</TouchableOpacity>
...
<TextInput
      style={styles.input}
      placeholder="Hepatitis B Vaccine batch number"
      value={batchNumbera}
...
<TextInput
      style={styles.input}
      placeholder="Hepatitis B Vaccine expiring date.     Format: January 7, 2019"
      value={expiryDatea}
...
<TextInput
      style={styles.input}
      placeholder="Hepatitis B Vaccine opening balance"
...
<View style={styles.questionaireContainer}>
  <ThemedText style={styles.subHeading}>HEPATITIS B Vaccine temp at pickup </ThemedText>
  <View style={styles.ageGradeContainer}>
...
<TextInput
      style={styles.input}
      placeholder="Hepatitis B Diluent batch number"
      value={diluentBatchNumber}
      onChangeText={setDiluentBatchNumber}
    />
...
<TextInput
      style={styles.input}
      placeholder="Hepatitis B Diluent expiring date.     Format: MM/DD/YY 01/17/2019"
      value={diluentExpiryDate}
...
<TextInput
      style={styles.input}
      placeholder="Hepatitis B Diluent opening balance"
      value={diluentOpeningBalancea}
      onChangeText={setDiluentOpeningBalancea}
    />
<View  style={styles.questionaireContainer}>
<ThemedText style={styles.subHeading}>HEPATITIS B Diluent mismatch adjustment: {}</ThemedText>
</View>


<TextInput
      style={styles.input}
      placeholder="Hepatitis B 0.05ml syringe opening balance"
      value={syringeOpeningBalance}
      onChangeText={setSyringeOpeningBalance}
    />
...
<TextInput
      style={styles.input}
      placeholder="Hepatitis B 2ml syringe opening balance"
      value={mlsyringeOpeningBalance}
      onChangeText={setMlsyringeOpeningBalance}
    />
...
<TextInput
    style={styles.input}
    placeholder="2ml Hepatitis B Syringe mismatch"
...
<TextInput
    style={styles.input}
    placeholder="Hepatitis B Vaccine average monthly requirement"
    value={averageMonthlyRequirement}
    onChangeText={setAverageMonthlyRequirement}
  /> 
...
<TextInput
    style={styles.input}
    placeholder="Hepatitis B vaccine maximum stock quantity"
    value={maximumStock}
...
<TextInput
  style={styles.input}
  placeholder="Hepatitis B vaccine doses to issue up to monthly MSQ"
