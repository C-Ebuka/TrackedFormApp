...
export default function YellowFeverScreen() {
  ...
  const [showAlertYFV, setShowAlertYFV] = useState(false);
  ...
  const [totalYFVDiluentAvailable, setTotalYFVDiluentAvailable] = useState('');
  const [vaccine5requiredToMatchYFVAvail, setVaccine5requiredToMatchYFVAvail] = useState('');
...
const handleYFVDateChange = (text: string) => {
  setExpiryDate(text);
  const validityMessage: string = isValidDate(text); // Ensure validityMessage is typed as string
  setShowAlertYFV(validityMessage !== 'valid' && text.trim().length > 0);
};
...
useEffect(() => {
  ...
  if (openingBalance && diluentOpeningBalance) {
    const YFVOpening = parseInt(openingBalance);
    const diluentOpening = parseInt(diluentOpeningBalance);
    const diluentMismatchAdjustment = YFVOpening - diluentOpening;
  ...
  if (vaccineTotal && syringeOpeningBalance) {
    const vaccine5requiredToMatchYFVAvailCalc = parseInt(vaccineTotal) - (Number(syringeOpeningBalance));
    setVaccine5requiredToMatchYFVAvail(vaccine5requiredToMatchYFVAvailCalc.toString()); 
  }
 
  if (diluentOpeningBalance && diluentIssued ) {
    const totalYFVDiluentAvailableCalc =  (parseInt(diluentOpeningBalance) + parseInt(diluentIssued));
    setTotalYFVDiluentAvailable(totalYFVDiluentAvailableCalc.toString());

  }
  
  if (diluentOpeningBalance && vaccineTotal && diluentIssued && totalYFVDiluentAvailable) {
    const dilAvailableMismatchCalc = parseInt(vaccineTotal) - (parseInt(totalYFVDiluentAvailable));
  ...
  return (
    <ParallaxScrollView
      ...
      <ThemedView style={styles.formContainer}>
        ...
        <ThemedText style={styles.header}>YELLOW FEVER VACCINE LOGISTICS DATA</ThemedText>
...
<View>
<Text style={styles.label}>YELLOW FEVER VACCINE BATCH NUMBER</Text>
<TextInput
      style={styles.input}
      placeholder="Enter Yellow Fever Vaccine batch number"
      value={batchNumber}
...
<View>
  <Text style={styles.label}>YELLOW FEVER VACCINE EXPIRY DATE [MM/DD/YYYY]</Text>
  <TextInput
    style={styles.input}
    placeholder="Enter Yellow Fever Vaccine expiring date. Format: MM/DD/YYYY"
    value={expiryDate}
    onChangeText={handleYFVDateChange}
  />
  {showAlertYFV && (
...
<View>
<Text style={styles.label}>YELLOW FEVER DILUENT BATCH NUMBER</Text>
<TextInput
      style={styles.input}
      placeholder="Enter Yellow Fever Diluent batch number"
...
<View>
  <Text style={styles.label}>YELLOW FEVER DILUENT EXPIRY DATE [MM/DD/YYYY]</Text>
  <TextInput
    style={styles.input}
    placeholder="Yellow Fever Diluent expiring date. Format: MM/DD/YYYY"
...
<View>
<Text style={styles.label}>YELLOW FEVER 0.05ML SYRINGE BATCH NUMBER</Text>
<TextInput
      style={styles.input}
      placeholder="Enter Yellow Fever Syringe 0.05ml batch number"
...
<View>
  <Text style={styles.label}>YELLOW FEVER 0.05ML SYRINGE EXPIRY DATE [MM/DD/YYYY]</Text>
  <TextInput
    style={styles.input}
    placeholder="Enter Yellow Fever Syringe 0.05ml expiring date. Format: MM/DD/YYYY"
...
<View>
<Text style={styles.label}>YELLOW FEVER 2ML SYRINGE BATCH NUMBER</Text>
<TextInput
      style={styles.input}
      placeholder="Enter Yellow Fever 2ml Syringe batch number"
...
<View>
  <Text style={styles.label}>YELLOW FEVER 2ML SYRINGE EXPIRY DATE [MM/DD/YYYY]</Text>
  <TextInput
    style={styles.input}
    placeholder="Yellow Fever Syringe 2ml expiring date. Format: MM/DD/YYYY"
...
<View style={styles.questionaireContainer}>
  <ThemedText style={styles.subHeading}>YELLOW FEVER VACCINE TEMP AT PICK-UP</ThemedText>
...
<View  style={styles.questionaireContainer}>
  <ThemedText style={styles.subHeading}>YELLOW FEVER VACCINE VVM STAGE AT PICKUP </ThemedText>
  <View style={styles.ageGradeContainer}>
...
<View>
<Text style={styles.label}>YELLOW FEVER VACCINE OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text>
<TextInput
      style={styles.input}
      placeholder="Enter Yellow Fever Vaccine opening balance"
...
<View  style={styles.calc}>
  <ThemedText style={styles.subHeading}>YELLOW FEVER VACCINE OPENING BALANCE IN AMPOULES :</ThemedText>
  {openingBalance && (
...
<View>
<Text style={styles.label}>YELLOW FEVER DILUENT OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text>
<TextInput
      style={styles.input}
      placeholder="Enter Yellow Fever Diluent opening balance"
...
<View  style={styles.calc}>
  <ThemedText style={styles.subHeading}>YELLOW FEVER DILUENT OPENING BALANCE IN AMPOULES :</ThemedText>
  {diluentOpeningBalance && (
...
<View  style={styles.calc}>
  <ThemedText style={styles.subHeading}>YELLOW FEVER DILUENT MISMATCH :</ThemedText>
  {diluentMismatch && (
    <>
      <ThemedText style={styles.mismatch}>
        {diluentMismatch} 
...
<View>
<Text style={styles.label}>YELLOW FEVER 0.05ML SYRINGE OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
<TextInput
      style={styles.input}
      placeholder="Enter Yellow Fever 0.05ml syringe opening balance"
...
<View  style={styles.calc}>
  <ThemedText style={styles.subHeading}>YELLOW FEVER SYRINGE 0.05ML MISMATCH :</ThemedText>
  {syringe5mismatch && (
...
<View>
<Text style={styles.label}>YELLOW FEVER 2ML SYRINGE OPENING BALANCE </Text> 
<TextInput
      style={styles.input}
      placeholder="Enter Yellow Fever 2ml syringe opening balance"
...
<View  style={styles.calc}>
<ThemedText style={styles.subHeading}>YELLOW FEVER SYRINGE 2ML MISMATCH :</ThemedText>
  {syringe2mismatch && (
      <ThemedText style={styles.mismatch}>
...
<View>
<Text style={styles.label}>YELLOW FEVER VACCINE AVERAGE MONTHLY REQUIREMENT  (AMR) (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
<TextInput
    style={styles.input}
    placeholder="Enter Yellow Fever Vaccine average monthly requirement"
...
<ThemedText style={styles.subHeading}>MMSQ MULTIPLICATION FACTOR:</ThemedText>
  ...
  <ThemedText style={styles.subHeading}>YELLOW FEVER VACCINE MONTHLY MAXIMUM STOCK QUANTITY:</ThemedText>
...
<View style={styles.calc}>
  <ThemedText style={styles.subHeading}>
    YELLOW FEVER VACCINE DOSES REQUIRED TO MAKE UP TO MAXIMUM STOCK:
  </ThemedText>
  {dosesToIssueUp && (
    <ThemedText style={styles.mismatch}>
...
<View>
<Text style={styles.label}>ACTUAL YELLOW FEVER VACCINE DOSES ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
<TextInput
  style={styles.input}
  placeholder="Yellow Fever vaccine doses issued "
...
<View style={styles.calc}>
  <ThemedText style={styles.subHeading}>
  Total Yellow Fever vaccine available:
  </ThemedText>
  {vaccineTotal && (
    <ThemedText style={styles.mismatch}>
...
<View style={styles.calc}>
  <ThemedText style={styles.subHeading}>
 QUANTITY (DOSES) OF DILUENT REQUIRED TO MATCH TOTAL AVAILABLE YELLOW FEVER VACCINE (FACTORING IN OPENING BALANCE):
 </ThemedText>
</View>
<ThemedText>
  {vaccineTotal && (
...
<View>
<Text style={styles.label}>ACTUAL QUANTITY (DOSES) OF YELLOW FEVER DILUENT ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
<TextInput
  style={styles.input}
  placeholder="Yellow Fever diluent issued "
  value={diluentIssued}
...
<View style={styles.calc}>
  <ThemedText style={styles.subHeading}>
  QUANTITY OF 0.05ML SYRINGE REQUIRED TO MATCH TOTAL YELLOW FEVER VACCINE AVAILABLE (FACTORING IN OPENING BALANCE):
  </ThemedText>
  {vaccineTotal && (
    <ThemedText style={styles.mismatch}>
      {vaccine5requiredToMatchYFVAvail} pcs
    </ThemedText>
  )}
</View>

<View>
<Text style={styles.label}>ACTUAL YELLOW FEVER 0.05ML SYRINGE QUANTITY ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
<TextInput
  style={styles.input}
  placeholder="Yellow Fever 0.05ml syringe Quantity Issued "
...
<View style={styles.calc}>
  <ThemedText style={styles.subHeading}>
  QUANTITY OF 2ML SYRINGE REQUIRED TO MATCH TOTAL YELLOW FEVER VACCINE AVAILABLE (FACTORING IN OPENING BALANCE):
  </ThemedText>
  {vaccineTotal && (
    <ThemedText style={styles.mismatch}>
...
<View>
<Text style={styles.label}>ACTUAL YELLOW FEVER 2ML SYRINGE QUANTITY ISSUED </Text> 
<TextInput
    style={styles.input}
    placeholder="Yellow Fever 2ml syringe Quantity Issued "
...
<View style={styles.questionaireContainer}>
  <ThemedText style={styles.subHeading}>YELLOW FEVER VACCINE TEMP AT ISSUE</ThemedText>
  <View style={styles.ageGradeContainer}>
...
<ThemedText style={styles.subHeading}>YELLOW FEVER VACCINE VVM STAGE AT ISSUE</ThemedText>
  <View style={styles.ageGradeContainer}>
...
<Text style={styles.buttonText}>
  Fill another Yellow Fever Logistics form for a different manufacturer
</Text>
</TouchableOpacity>
...
<TextInput
      style={styles.input}
      placeholder="Yellow Fever Vaccine batch number"
      value={batchNumbera}
...
<TextInput
      style={styles.input}
      placeholder="Yellow Fever Vaccine expiring date.     Format: January 7, 2019"
      value={expiryDatea}
...
<TextInput
      style={styles.input}
      placeholder="Yellow Fever Vaccine opening balance"
...
<View style={styles.questionaireContainer}>
  <ThemedText style={styles.subHeading}>Yellow Fever Vaccine temp at pickup </ThemedText>
  <View style={styles.ageGradeContainer}>
...
<TextInput
      style={styles.input}
      placeholder="Yellow Fever Diluent batch number"
      value={diluentBatchNumber}
      onChangeText={setDiluentBatchNumber}
    />
...
<TextInput
      style={styles.input}
      placeholder="Yellow Fever Diluent expiring date.     Format: MM/DD/YY 01/17/2019"
      value={diluentExpiryDate}
...
<TextInput
      style={styles.input}
      placeholder="Yellow Fever Diluent opening balance"
      value={diluentOpeningBalancea}
      onChangeText={setDiluentOpeningBalancea}
    />
<View  style={styles.questionaireContainer}>
<ThemedText style={styles.subHeading}>Yellow Fever Diluent mismatch adjustment: {}</ThemedText>
</View>


<TextInput
      style={styles.input}
      placeholder="Yellow Fever 0.05ml syringe opening balance"
      value={syringeOpeningBalance}
      onChangeText={setSyringeOpeningBalance}
    />
...
<TextInput
      style={styles.input}
      placeholder="Yellow Fever 2ml syringe opening balance"
      value={mlsyringeOpeningBalance}
      onChangeText={setMlsyringeOpeningBalance}
    />
...
<TextInput
    style={styles.input}
    placeholder="Yellow Fever Vaccine average monthly requirement"
    value={averageMonthlyRequirement}
    onChangeText={setAverageMonthlyRequirement}
  /> 
...
<TextInput
    style={styles.input}
    placeholder="Yellow Fever vaccine maximum stock quantity"
    value={maximumStock}
...
<TextInput
  style={styles.input}
  placeholder="Yellow Fever vaccine doses to issue up to monthly MSQ"
