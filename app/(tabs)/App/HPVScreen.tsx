...
export default function HPVScreen() {
  ...
  const [showAlertHPV, setShowAlertHPV] = useState(false);
  ...
  const [totalHpvDiluentAvailable, setTotalHpvDiluentAvailable] = useState('');
  const [vaccine5requiredToMatchHpvAvail, setVaccine5requiredToMatchHpvAvail] = useState('');
...
const handleHPVDateChange = (text: string) => {
  setExpiryDate(text);
  const validityMessage: string = isValidDate(text); // Ensure validityMessage is typed as string
  setShowAlertHPV(validityMessage !== 'valid' && text.trim().length > 0);
};
...
const navigateForward = () => {
    navigation.navigate('IPVScreen'); 
    };
  
  // Function to navigate to the previous screen
  const navigateBackward = () => {
  navigation.navigate('HepBScreen'); 
  };
  ...
  useEffect(() => {
    ...
    if (openingBalance && diluentOpeningBalance) {
      const hpvOpening = parseInt(openingBalance);
      const diluentOpening = parseInt(diluentOpeningBalance);
      const diluentMismatchAdjustment = hpvOpening - diluentOpening;
    ...
    if (vaccineTotal && syringeOpeningBalance) {
      const vaccine5requiredToMatchHpvAvailCalc = parseInt(vaccineTotal) - (Number(syringeOpeningBalance));
      setVaccine5requiredToMatchHpvAvail(vaccine5requiredToMatchHpvAvailCalc.toString()); 
    }
   
    if (diluentOpeningBalance && diluentIssued ) {
      const totalHpvDiluentAvailableCalc =  (parseInt(diluentOpeningBalance) + parseInt(diluentIssued));
      setTotalHpvDiluentAvailable(totalHpvDiluentAvailableCalc.toString());

    }
    
    if (diluentOpeningBalance && vaccineTotal && diluentIssued && totalHpvDiluentAvailable) {
      const dilAvailableMismatchCalc = parseInt(vaccineTotal) - (parseInt(totalHpvDiluentAvailable));
  ...
  return (
    <ParallaxScrollView
      ...
      <ThemedView style={styles.formContainer}>
        ...
        <ThemedText style={styles.header}>HPV LOGISTICS DATA</ThemedText>
...
<View>
<Text style={styles.label}>HPV VACCINE BATCH NUMBER</Text>
<TextInput
      style={styles.input}
      placeholder="Enter HPV Vaccine batch number"
      value={batchNumber}
...
<View>
  <Text style={styles.label}>HPV VACCINE EXPIRY DATE [MM/DD/YYYY]</Text>
  <TextInput
    style={styles.input}
    placeholder="Enter HPV Vaccine expiring date. Format: MM/DD/YYYY"
    value={expiryDate}
    onChangeText={handleHPVDateChange}
  />
  {showAlertHPV && (
...
<View>
<Text style={styles.label}>HPV DILUENT BATCH NUMBER</Text>
<TextInput
      style={styles.input}
      placeholder="Enter HPV Diluent batch number"
...
<View>
  <Text style={styles.label}>HPV DILUENT EXPIRY DATE [MM/DD/YYYY]</Text>
  <TextInput
    style={styles.input}
    placeholder="HPV Diluent expiring date. Format: MM/DD/YYYY"
...
<View>
<Text style={styles.label}>HPV 0.05ML SYRINGE BATCH NUMBER</Text>
<TextInput
      style={styles.input}
      placeholder="Enter HPV Syringe 0.05ml batch number"
...
<View>
  <Text style={styles.label}>HPV 0.05ML SYRINGE EXPIRY DATE [MM/DD/YYYY]</Text>
  <TextInput
    style={styles.input}
    placeholder="Enter HPV Syringe 0.05ml expiring date. Format: MM/DD/YYYY"
...
<View>
<Text style={styles.label}>HPV 2ML SYRINGE BATCH NUMBER</Text>
<TextInput
      style={styles.input}
      placeholder="Enter HPV 2ml Syringe batch number"
...
<View>
  <Text style={styles.label}>HPV 2ML SYRINGE EXPIRY DATE [MM/DD/YYYY]</Text>
  <TextInput
    style={styles.input}
    placeholder="HPV Syringe 2ml expiring date. Format: MM/DD/YYYY"
...
<View style={styles.questionaireContainer}>
  <ThemedText style={styles.subHeading}>HPV VACCINE TEMP AT PICK-UP</ThemedText>
...
<View  style={styles.questionaireContainer}>
  <ThemedText style={styles.subHeading}>HPV VACCINE VVM STAGE AT PICKUP </ThemedText>
  <View style={styles.ageGradeContainer}>
...
<View>
<Text style={styles.label}>HPV VACCINE OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text>
<TextInput
      style={styles.input}
      placeholder="Enter HPV Vaccine opening balance"
...
<View  style={styles.calc}>
  <ThemedText style={styles.subHeading}>HPV VACCINE OPENING BALANCE IN AMPOULES :</ThemedText>
  {openingBalance && (
...
<View>
<Text style={styles.label}>HPV DILUENT OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text>
<TextInput
      style={styles.input}
      placeholder="Enter HPV Diluent opening balance"
...
<View  style={styles.calc}>
  <ThemedText style={styles.subHeading}>HPV DILUENT OPENING BALANCE IN AMPOULES :</ThemedText>
  {diluentOpeningBalance && (
...
<View  style={styles.calc}>
  <ThemedText style={styles.subHeading}>HPV DILUENT MISMATCH :</ThemedText>
  {diluentMismatch && (
    <>
      <ThemedText style={styles.mismatch}>
        {diluentMismatch} 
...
<View>
<Text style={styles.label}>HPV 0.05ML SYRINGE OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
<TextInput
      style={styles.input}
      placeholder="Enter HPV 0.05ml syringe opening balance"
...
<View  style={styles.calc}>
  <ThemedText style={styles.subHeading}>HPV SYRINGE 0.05ML MISMATCH :</ThemedText>
  {syringe5mismatch && (
...
<View>
<Text style={styles.label}>HPV 2ML SYRINGE OPENING BALANCE </Text> 
<TextInput
      style={styles.input}
      placeholder="Enter HPV 2ml syringe opening balance"
...
<View  style={styles.calc}>
<ThemedText style={styles.subHeading}>HPV SYRINGE 2ML MISMATCH :</ThemedText>
  {syringe2mismatch && (
      <ThemedText style={styles.mismatch}>
...
<View>
<Text style={styles.label}>HPV VACCINE AVERAGE MONTHLY REQUIREMENT  (AMR) (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
<TextInput
    style={styles.input}
    placeholder="Enter HPV Vaccine average monthly requirement"
...
<ThemedText style={styles.subHeading}>MMSQ MULTIPLICATION FACTOR:</ThemedText>
  ...
  <ThemedText style={styles.subHeading}>HPV VACCINE MONTHLY MAXIMUM STOCK QUANTITY:</ThemedText>
...
<View style={styles.calc}>
  <ThemedText style={styles.subHeading}>
    HPV VACCINE DOSES REQUIRED TO MAKE UP TO MAXIMUM STOCK:
  </ThemedText>
  {dosesToIssueUp && (
    <ThemedText style={styles.mismatch}>
...
<View>
<Text style={styles.label}>ACTUAL HPV VACCINE DOSES ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
<TextInput
  style={styles.input}
  placeholder="HPV vaccine doses issued "
...
<View style={styles.calc}>
  <ThemedText style={styles.subHeading}>
 QUANTITY (DOSES) OF DILUENT REQUIRED TO MATCH TOTAL AVAILABLE HPV VACCINE (FACTORING IN OPENING BALANCE):
 </ThemedText>
</View>
<ThemedText>
  {vaccineTotal && (
...
<View>
<Text style={styles.label}>ACTUAL QUANTITY (DOSES) OF HPV DILUENT ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
<TextInput
  style={styles.input}
  placeholder="HPV diluent issued "
  value={diluentIssued}
...
<View style={styles.calc}>
  <ThemedText style={styles.subHeading}>
  QUANTITY OF 0.05ML SYRINGE REQUIRED TO MATCH TOTAL HPV VACCINE AVAILABLE (FACTORING IN OPENING BALANCE):
  </ThemedText>
  {vaccineTotal && (
    <ThemedText style={styles.mismatch}>
      {vaccine5requiredToMatchHpvAvail} pcs
    </ThemedText>
  )}
</View>

<View>
<Text style={styles.label}>ACTUAL HPV 0.05ML SYRINGE QUANTITY ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
<TextInput
  style={styles.input}
  placeholder="HPV 0.05ml syringe Quantity Issued "
...
<View style={styles.calc}>
  <ThemedText style={styles.subHeading}>
  QUANTITY OF 2ML SYRINGE REQUIRED TO MATCH TOTAL HPV VACCINE AVAILABLE (FACTORING IN OPENING BALANCE):
  </ThemedText>
  {vaccineTotal && (
    <ThemedText style={styles.mismatch}>
...
<View>
<Text style={styles.label}>ACTUAL HPV 2ML SYRINGE QUANTITY ISSUED </Text> 
<TextInput
    style={styles.input}
    placeholder="HPV 2ml syringe Quantity Issued "
...
<View style={styles.questionaireContainer}>
  <ThemedText style={styles.subHeading}>HPV VACCINE TEMP AT ISSUE</ThemedText>
  <View style={styles.ageGradeContainer}>
...
<ThemedText style={styles.subHeading}>HPV VACCINE VVM STAGE AT ISSUE</ThemedText>
  <View style={styles.ageGradeContainer}>
...
<Text style={styles.buttonText}>
  Fill another HPV Logistics form for a different manufacturer
</Text>
</TouchableOpacity>
...
<TextInput
      style={styles.input}
      placeholder="HPV Vaccine batch number"
      value={batchNumbera}
...
<TextInput
      style={styles.input}
      placeholder="HPV Vaccine expiring date.     Format: January 7, 2019"
      value={expiryDatea}
...
<TextInput
      style={styles.input}
      placeholder="HPV Vaccine opening balance"
...
<View style={styles.questionaireContainer}>
  <ThemedText style={styles.subHeading}>HPV Vaccine temp at pickup </ThemedText>
  <View style={styles.ageGradeContainer}>
...
<TextInput
      style={styles.input}
      placeholder="HPV Diluent batch number"
      value={diluentBatchNumber}
      onChangeText={setDiluentBatchNumber}
    />
...
<TextInput
      style={styles.input}
      placeholder="HPV Diluent expiring date.     Format: MM/DD/YY 01/17/2019"
      value={diluentExpiryDate}
...
<TextInput
      style={styles.input}
      placeholder="HPV Diluent opening balance"
      value={diluentOpeningBalancea}
      onChangeText={setDiluentOpeningBalancea}
    />
<View  style={styles.questionaireContainer}>
<ThemedText style={styles.subHeading}>HPV Diluent mismatch adjustment: {}</ThemedText>
</View>


<TextInput
      style={styles.input}
      placeholder="HPV 0.05ml syringe opening balance"
      value={syringeOpeningBalance}
      onChangeText={setSyringeOpeningBalance}
    />
...
<TextInput
      style={styles.input}
      placeholder="HPV 2ml syringe opening balance"
      value={mlsyringeOpeningBalance}
      onChangeText={setMlsyringeOpeningBalance}
    />
...
<TextInput
    style={styles.input}
    placeholder="HPV Vaccine average monthly requirement"
    value={averageMonthlyRequirement}
    onChangeText={setAverageMonthlyRequirement}
  /> 
...
<TextInput
    style={styles.input}
    placeholder="HPV vaccine maximum stock quantity"
    value={maximumStock}
...
<TextInput
  style={styles.input}
  placeholder="HPV vaccine doses to issue up to monthly MSQ"
