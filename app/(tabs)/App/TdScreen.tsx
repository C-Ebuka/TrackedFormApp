...
export default function TdScreen() {
  ...
  const [showAlertTD, setShowAlertTD] = useState(false);
  ...
  const [totalTDDiluentAvailable, setTotalTDDiluentAvailable] = useState('');
  const [vaccine5requiredToMatchTDAvail, setVaccine5requiredToMatchTDAvail] = useState('');
...
const handleTDDateChange = (text: string) => {
  setExpiryDate(text);
  const validityMessage: string = isValidDate(text); // Ensure validityMessage is typed as string
  setShowAlertTD(validityMessage !== 'valid' && text.trim().length > 0);
};
...
const navigateBackward = () => {
     navigation.navigate('RotaScreen');
 };
 ...
 useEffect(() => {
  ...
  if (openingBalance && diluentOpeningBalance) {
    const TDOpening = parseInt(openingBalance);
    const diluentOpening = parseInt(diluentOpeningBalance);
    const diluentMismatchAdjustment = TDOpening - diluentOpening;
  ...
  if (vaccineTotal && syringeOpeningBalance) {
    const vaccine5requiredToMatchTDAvailCalc = parseInt(vaccineTotal) - (Number(syringeOpeningBalance));
    setVaccine5requiredToMatchTDAvail(vaccine5requiredToMatchTDAvailCalc.toString()); 
  }
 
  if (diluentOpeningBalance && diluentIssued ) {
    const totalTDDiluentAvailableCalc =  (parseInt(diluentOpeningBalance) + parseInt(diluentIssued));
    setTotalTDDiluentAvailable(totalTDDiluentAvailableCalc.toString());

  }
  
  if (diluentOpeningBalance && vaccineTotal && diluentIssued && totalTDDiluentAvailable) {
    const dilAvailableMismatchCalc = parseInt(vaccineTotal) - (parseInt(totalTDDiluentAvailable));
  ...
  return (
    <ParallaxScrollView
      ...
      <ThemedView style={styles.formContainer}>
        ...
        <ThemedText style={styles.header}>TETANUS DIPHTHERIA VACCINE LOGISTICS DATA</ThemedText>
        ...
        <View>
        <Text style={styles.label}>TETANUS DIPHTHERIA VACCINE VACCINE BATCH NUMBER</Text>
        <TextInput
              style={styles.input}
              placeholder="Enter Tetanus Diphtheria Vaccine batch number"
              value={batchNumber}
        ...
        <View>
          <Text style={styles.label}>TETANUS DIPHTHERIA VACCINE VACCINE EXPIRY DATE [MM/DD/YYYY]</Text>
          <TextInput
            style={styles.input}
            placeholder="Enter Tetanus Diphtheria Vaccine expiring date. Format: MM/DD/YYYY"
            value={expiryDate}
            onChangeText={handleTDDateChange}
          />
          {showAlertTD && (
        ...
        <View>
        <Text style={styles.label}>TETANUS DIPHTHERIA DILUENT BATCH NUMBER</Text>
        <TextInput
              style={styles.input}
              placeholder="Enter Tetanus Diphtheria Diluent batch number"
        ...
        <View>
          <Text style={styles.label}>TETANUS DIPHTHERIA DILUENT EXPIRY DATE [MM/DD/YYYY]</Text>
          <TextInput
            style={styles.input}
            placeholder="Tetanus Diphtheria Diluent expiring date. Format: MM/DD/YYYY"
        ...
        <View>
        <Text style={styles.label}>TETANUS DIPHTHERIA 0.05ML SYRINGE BATCH NUMBER</Text>
        <TextInput
              style={styles.input}
              placeholder="Enter Tetanus Diphtheria Syringe 0.05ml batch number"
        ...
        <View>
          <Text style={styles.label}>Tetanus Diphtheria 0.05ML SYRINGE EXPIRY DATE [MM/DD/YYYY]</Text>
          <TextInput
            style={styles.input}
            placeholder="Enter Tetanus Diphtheria Syringe 0.05ml expiring date. Format: MM/DD/YYYY"
        ...
        <View>
        <Text style={styles.label}>TETANUS DIPHTHERIA 2ML SYRINGE BATCH NUMBER</Text>
        <TextInput
              style={styles.input}
              placeholder="Enter Tetanus Diphtheria 2ml Syringe batch number"
        ...
        <View>
          <Text style={styles.label}>TETANUS DIPHTHERIA 2ML SYRINGE EXPIRY DATE [MM/DD/YYYY]</Text>
          <TextInput
            style={styles.input}
            placeholder="Tetanus Diphtheria Syringe 2ml expiring date. Format: MM/DD/YYYY"
...
<View style={styles.questionaireContainer}>
          <ThemedText style={styles.subHeading}>TETANUS DIPHTHERIA VACCINE TEMP AT PICK-UP</ThemedText>
  ...
  <View style={styles.questionaireContainer}>
    ...
    >
      ...
      <Picker.Item label="above 2 hrs" value="above 2 hrs" />
        ...
        <View  style={styles.questionaireContainer}>
          <ThemedText style={styles.subHeading}>TETANUS DIPHTHERIA VACCINE VVM STAGE AT PICKUP </ThemedText>
          <View style={styles.ageGradeContainer}>
        ...
        <View>
        <Text style={styles.label}>TETANUS DIPHTHERIA VACCINE OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text>
        <TextInput
              style={styles.input}
              placeholder="Enter Tetanus Diphtheria Vaccine opening balance"
        ...
        <View  style={styles.calc}>
          <ThemedText style={styles.subHeading}>TETANUS DIPHTHERIA VACCINE OPENING BALANCE IN AMPOULES :</ThemedText>
          {openingBalance && (
        ...
        <View>
        <Text style={styles.label}>TETANUS DIPHTHERIA DILUENT OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text>
        <TextInput
              style={styles.input}
              placeholder="Enter Tetanus Diphtheria Diluent opening balance"
        ...
        <View  style={styles.calc}>
          <ThemedText style={styles.subHeading}>TETANUS DIPHTHERIA DILUENT OPENING BALANCE IN AMPOULES :</ThemedText>
          {diluentOpeningBalance && (
        ...
        <View  style={styles.calc}>
          <ThemedText style={styles.subHeading}>TETANUS DIPHTHERIA DILUENT MISMATCH :</ThemedText>
          {diluentMismatch && (
            <>
              <ThemedText style={styles.mismatch}>
                {diluentMismatch} 
        ...
        <View>
        <Text style={styles.label}>TETANUS DIPHTHERIA 0.05ML SYRINGE OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
        <TextInput
              style={styles.input}
              placeholder="Enter Tetanus Diphtheria 0.05ml syringe opening balance"
        ...
        <View  style={styles.calc}>
          <ThemedText style={styles.subHeading}>TETANUS DIPHTHERIA SYRINGE 0.05ML MISMATCH :</ThemedText>
          {syringe5mismatch && (
        ...
        <View>
        <Text style={styles.label}>TETANUS DIPHTHERIA 2ML SYRINGE OPENING BALANCE </Text> 
        <TextInput
              style={styles.input}
              placeholder="Enter Tetanus Diphtheria 2ml syringe opening balance"
        ...
        <View  style={styles.calc}>
        <ThemedText style={styles.subHeading}>TETANUS DIPHTHERIA SYRINGE 2ML MISMATCH :</ThemedText>
          {syringe2mismatch && (
              <ThemedText style={styles.mismatch}>
        ...
        <View>
        <Text style={styles.label}>TETANUS DIPHTHERIA VACCINE AVERAGE MONTHLY REQUIREMENT  (AMR) (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
        <TextInput
            style={styles.input}
            placeholder="Enter Tetanus Diphtheria Vaccine average monthly requirement"
        ...
        <ThemedText style={styles.subHeading}>MMSQ MULTIPLICATION FACTOR:</ThemedText>
          ...
          <ThemedText style={styles.subHeading}>TETANUS DIPHTHERIA VACCINE MONTHLY MAXIMUM STOCK QUANTITY:</ThemedText>
        ...
        <View style={styles.calc}>
          ...
          TETANUS DIPHTHERIA VACCINE DOSES REQUIRED TO MAKE UP TO MAXIMUM STOCK:
          </ThemedText>
          {dosesToIssueUp && (
            <ThemedText style={styles.mismatch}>
        ...
        <View>
        <Text style={styles.label}>ACTUAL TETANUS DIPHTHERIA VACCINE DOSES ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
        <TextInput
          style={styles.input}
          placeholder="Tetanus Diphtheria vaccine doses issued "
        ...
        <View style={styles.calc}>
          <ThemedText style={styles.subHeading}>
          Total Tetanus Diphtheria vaccine available:
          </ThemedText>
          {vaccineTotal && (
            <ThemedText style={styles.mismatch}>
        ...
        <View style={styles.calc}>
          <ThemedText style={styles.subHeading}>
         QUANTITY (DOSES) OF DILUENT REQUIRED TO MATCH TOTAL AVAILABLE TETANUS DIPHTHERIA VACCINE (FACTORING IN OPENING BALANCE):
         </ThemedText>
        </View>
        <ThemedText>
          {vaccineTotal && (
        ...
        <View>
        <Text style={styles.label}>ACTUAL QUANTITY (DOSES) OF TETANUS DIPHTHERIA DILUENT ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
        <TextInput
          style={styles.input}
          placeholder="Tetanus Diphtheria diluent issued "
          value={diluentIssued}
        ...
        <View style={styles.calc}>
          <ThemedText style={styles.subHeading}>
          QUANTITY OF 0.05ML SYRINGE REQUIRED TO MATCH TOTAL TETANUS DIPHTHERIA VACCINE AVAILABLE (FACTORING IN OPENING BALANCE):
          </ThemedText>
          {vaccineTotal && (
            <ThemedText style={styles.mismatch}>
              {vaccine5requiredToMatchTDAvail} pcs
            </ThemedText>
          )}
        </View>

        <View>
        <Text style={styles.label}>ACTUAL TETANUS DIPHTHERIA 0.05ML SYRINGE QUANTITY ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
      <TextInput
          style={styles.input}
          placeholder="Tetanus Diphtheria 0.05ml syringe Quantity Issued "
        ...
        <View style={styles.calc}>
          <ThemedText style={styles.subHeading}>
          QUANTITY OF 2ML SYRINGE REQUIRED TO MATCH TOTAL TETANUS DIPHTHERIA VACCINE AVAILABLE (FACTORING IN OPENING BALANCE):
          </ThemedText>
          {vaccineTotal && (
            <ThemedText style={styles.mismatch}>
        ...
        <View>
        <Text style={styles.label}>ACTUAL TETANUS DIPHTHERIA 2ML SYRINGE QUANTITY ISSUED </Text> 
        <TextInput
            style={styles.input}
            placeholder="Tetanus Diphtheria 2ml syringe Quantity Issued "
  ...
  <View style={styles.questionaireContainer}>
          <ThemedText style={styles.subHeading}>TETANUS DIPHTHERIA VACCINE TEMP AT ISSUE</ThemedText>
          <View style={styles.ageGradeContainer}>
      ...
      <View  style={styles.questionaireContainer}>
        ...
        <ThemedText style={styles.subHeading}>TETANUS DIPHTHERIA VACCINE VVM STAGE AT ISSUE</ThemedText>
          <View style={styles.ageGradeContainer}>
      ...
      <TouchableOpacity onPress={handleGenerateFields} style={styles.buttonfill}>
        <Text style={styles.buttonText}>
          Fill another Tetanus Diphtheria Logistics form for a different manufacturer
        </Text>
      </TouchableOpacity>
        ...
        {generateFields && (
          ...
          <>
            ...
            TETANUS DIPHTHERIA LOGISTICS DATA
        ...
        <TextInput
              style={styles.input}
              placeholder="Tetanus Diphtheria Vaccine batch number"
              value={batchNumbera}
        ...
        <TextInput
              style={styles.input}
              placeholder="Tetanus Diphtheria Vaccine expiring date.     Format: January 7, 2019"
              value={expiryDatea}
        ...
        <TextInput
              style={styles.input}
              placeholder="Tetanus Diphtheria Vaccine opening balance"
...
<View style={styles.questionaireContainer}>
          <ThemedText style={styles.subHeading}>Tetanus Diphtheria Vaccine temp at pickup </ThemedText>
          <View style={styles.ageGradeContainer}>
        ...
        <TextInput
              style={styles.input}
              placeholder="Tetanus Diphtheria Diluent batch number"
              value={diluentBatchNumber}
              onChangeText={setDiluentBatchNumber}
            />
        ...
        <TextInput
              style={styles.input}
              placeholder="Tetanus Diphtheria Diluent expiring date.     Format: MM/DD/YY 01/17/2019"
              value={diluentExpiryDate}
        ...
        <TextInput
              style={styles.input}
              placeholder="Tetanus Diphtheria Diluent opening balance"
              value={diluentOpeningBalancea}
              onChangeText={setDiluentOpeningBalancea}
            />
        <View  style={styles.questionaireContainer}>
        <ThemedText style={styles.subHeading}>Tetanus Diphtheria Diluent mismatch adjustment: {}</ThemedText>
        </View>

        
        <TextInput
              style={styles.input}
              placeholder="Tetanus Diphtheria 0.05ml syringe opening balance"
              value={syringeOpeningBalance}
              onChangeText={setSyringeOpeningBalance}
            />
        ...
        <TextInput
              style={styles.input}
              placeholder="Tetanus Diphtheria 2ml syringe opening balance"
              value={mlsyringeOpeningBalance}
              onChangeText={setMlsyringeOpeningBalance}
            />
        ...
        <TextInput
            style={styles.input}
            placeholder="Tetanus Diphtheria Vaccine average monthly requirement"
            value={averageMonthlyRequirement}
            onChangeText={setAverageMonthlyRequirement}
          /> 
        ...
        <TextInput
            style={styles.input}
            placeholder="Tetanus Diphtheria vaccine maximum stock quantity"
            value={maximumStock}
        ...
        <TextInput
          style={styles.input}
          placeholder="Tetanus Diphtheria vaccine doses to issue up to monthly MSQ"
  ...
  <View style={styles.questionaireContainer}>
    ...
    <View style={styles.container}>
      <View style={styles.buttonContainer2}>
        <Button title="Previous" onPress={navigateBackward} color="#007AFF" />
      </View>
      <View style={styles.buttonContainer1}>
        <Button title="Next" onPress={navigateForward} color="#007AFF" />
      </View>
    </View>
