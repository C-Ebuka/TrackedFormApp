...
export default function PentaScreen() {
  ...
  const [showAlertPENTA, setShowAlertPENTA] = useState(false);
  ...
  const [totalPENTADiluentAvailable, setTotalPENTADiluentAvailable] = useState('');
  const [vaccine5requiredToMatchPENTAAvail, setVaccine5requiredToMatchPENTAAvail] = useState('');
...
const handlePENTADateChange = (text: string) => {
  setExpiryDate(text);
  const validityMessage: string = isValidDate(text); // Ensure validityMessage is typed as string
  setShowAlertPENTA(validityMessage !== 'valid' && text.trim().length > 0);
};
...
const navigateForward = () => {
  ...
  const navigateBackward = () => {
    navigation.navigate('MenAScreen');
  };
  ...
  useEffect(() => {
    ...
    if (openingBalance && diluentOpeningBalance) {
      const PENTAOpening = parseInt(openingBalance);
      const diluentOpening = parseInt(diluentOpeningBalance);
      const diluentMismatchAdjustment = PENTAOpening - diluentOpening;
    ...
    if (vaccineTotal && syringeOpeningBalance) {
      const vaccine5requiredToMatchPENTAAvailCalc = parseInt(vaccineTotal) - (Number(syringeOpeningBalance));
      setVaccine5requiredToMatchPENTAAvail(vaccine5requiredToMatchPENTAAvailCalc.toString()); 
    }
   
    if (diluentOpeningBalance && diluentIssued ) {
      const totalPENTADiluentAvailableCalc =  (parseInt(diluentOpeningBalance) + parseInt(diluentIssued));
      setTotalPENTADiluentAvailable(totalPENTADiluentAvailableCalc.toString());

    }
    
    if (diluentOpeningBalance && vaccineTotal && diluentIssued && totalPENTADiluentAvailable) {
      const dilAvailableMismatchCalc = parseInt(vaccineTotal) - (parseInt(totalPENTADiluentAvailable));
  ...
  return (
    <ParallaxScrollView
      ...
      <ThemedView style={styles.formContainer}>
        ...
        <ThemedText style={styles.header}>PENTAVALENT VACCINE LOGISTICS DATA</ThemedText>
...
<View>
<Text style={styles.label}>PENTAVALENT VACCINE BATCH NUMBER</Text>
<TextInput
      style={styles.input}
      placeholder="Enter Pentavalent Vaccine batch number"
      value={batchNumber}
...
<View>
  <Text style={styles.label}>PENTAVALENT VACCINE EXPIRY DATE [MM/DD/YYYY]</Text>
  <TextInput
    style={styles.input}
    placeholder="Enter Pentavalent Vaccine expiring date. Format: MM/DD/YYYY"
    value={expiryDate}
    onChangeText={handlePENTADateChange}
  />
  {showAlertPENTA && (
...
<View>
<Text style={styles.label}>PENTA DILUENT BATCH NUMBER</Text>
<TextInput
      style={styles.input}
      placeholder="Enter PENTA Diluent batch number"
...
<View>
  <Text style={styles.label}>PENTA DILUENT EXPIRY DATE [MM/DD/YYYY]</Text>
  <TextInput
    style={styles.input}
    placeholder="PENTA Diluent expiring date. Format: MM/DD/YYYY"
...
<View>
<Text style={styles.label}>PENTA 0.05ML SYRINGE BATCH NUMBER</Text>
<TextInput
      style={styles.input}
      placeholder="Enter PENTA Syringe 0.05ml batch number"
...
<View>
  <Text style={styles.label}>PENTA 0.05ML SYRINGE EXPIRY DATE [MM/DD/YYYY]</Text>
  <TextInput
    style={styles.input}
    placeholder="Enter PENTA Syringe 0.05ml expiring date. Format: MM/DD/YYYY"
...
<View>
<Text style={styles.label}>PENTA 2ML SYRINGE BATCH NUMBER</Text>
<TextInput
      style={styles.input}
      placeholder="Enter PENTA 2ml Syringe batch number"
...
<View>
  <Text style={styles.label}>PENTA 2ML SYRINGE EXPIRY DATE [MM/DD/YYYY]</Text>
  <TextInput
    style={styles.input}
    placeholder="PENTA Syringe 2ml expiring date. Format: MM/DD/YYYY"
...
<View style={styles.questionaireContainer}>
  <ThemedText style={styles.subHeading}>PENTA VACCINE TEMP AT PICK-UP</ThemedText>
...
<View  style={styles.questionaireContainer}>
  <ThemedText style={styles.subHeading}>PENTA VACCINE VVM STAGE AT PICKUP </ThemedText>
  <View style={styles.ageGradeContainer}>
...
<View>
<Text style={styles.label}>PENTA VACCINE OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text>
<TextInput
      style={styles.input}
      placeholder="Enter PENTA Vaccine opening balance"
...
<View  style={styles.calc}>
  <ThemedText style={styles.subHeading}>PENTA VACCINE OPENING BALANCE IN AMPOULES :</ThemedText>
  {openingBalance && (
...
<View>
<Text style={styles.label}>PENTA DILUENT OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text>
<TextInput
      style={styles.input}
      placeholder="Enter PENTA Diluent opening balance"
...
<View  style={styles.calc}>
  <ThemedText style={styles.subHeading}>PENTAVALENT DILUENT OPENING BALANCE IN AMPOULES :</ThemedText>
  {diluentOpeningBalance && (
...
<View  style={styles.calc}>
  <ThemedText style={styles.subHeading}>PENTAVALENT DILUENT MISMATCH :</ThemedText>
  {diluentMismatch && (
    <>
      <ThemedText style={styles.mismatch}>
        {diluentMismatch} 
      ...
      <ThemedText>
      PENTAVALENT DILUENT MISMATCH IN AMPOULES:
      </ThemedText>
      <ThemedText style={styles.mismatch}>            
...
<View>
<Text style={styles.label}>PENTAVALENT VACCINE 0.05ML SYRINGE OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
<TextInput
      style={styles.input}
      placeholder="Enter Pentavalent 0.05ml syringe opening balance"
...
<View  style={styles.calc}>
  <ThemedText style={styles.subHeading}>PENTAVALENT VACCINE SYRINGE 0.05ML MISMATCH :</ThemedText>
  {syringe5mismatch && (
...
<View>
<Text style={styles.label}>PENTAVALENT 2ML SYRINGE OPENING BALANCE </Text> 
<TextInput
      style={styles.input}
      placeholder="Enter Pentavalent  2ml syringe opening balance"
...
<View  style={styles.calc}>
<ThemedText style={styles.subHeading}>PENTAVALENT SYRINGE 2ML MISMATCH :</ThemedText>
  {syringe2mismatch && (
      <ThemedText style={styles.mismatch}>
...
<View>
<Text style={styles.label}>PENTAVALENT VACCINE AVERAGE MONTHLY REQUIREMENT  (AMR) (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
<TextInput
    style={styles.input}
    placeholder="Enter Pentavalent Vaccine average monthly requirement"
...
<ThemedText style={styles.subHeading}>MMSQ MULTIPLICATION FACTOR:</ThemedText>
  ...
  <ThemedText style={styles.subHeading}>PENTAVALENT VACCINE MONTHLY MAXIMUM STOCK QUANTITY:</ThemedText>
...
<View style={styles.calc}>
  <ThemedText style={styles.subHeading}>
    PENTAVALENT VACCINE DOSES REQUIRED TO MAKE UP TO MAXIMUM STOCK:
  </ThemedText>
  {dosesToIssueUp && (
    <ThemedText style={styles.mismatch}>
...
<View>
<Text style={styles.label}>ACTUAL PENTAVALENT VACCINE DOSES ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
<TextInput
  style={styles.input}
  placeholder="Pentavalent vaccine doses issued "
...
<View style={styles.calc}>
  <ThemedText style={styles.subHeading}>
  Total Pentavalent vaccine available:
  </ThemedText>
  {vaccineTotal && (
    <ThemedText style={styles.mismatch}>
...
<View style={styles.calc}>
  <ThemedText style={styles.subHeading}>
 QUANTITY (DOSES) OF DILUENT REQUIRED TO MATCH TOTAL AVAILABLE PENTAVALENT VACCINE (FACTORING IN OPENING BALANCE):
 </ThemedText>
</View>
<ThemedText>
  {vaccineTotal && (
...
<View>
<Text style={styles.label}>ACTUAL QUANTITY (DOSES) OF PENTAVALENT DILUENT ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
<TextInput
  style={styles.input}
  placeholder="Pentavalent diluent issued "
  value={diluentIssued}
...
<View style={styles.calc}>
  <ThemedText style={styles.subHeading}>
  QUANTITY OF 0.05ML SYRINGE REQUIRED TO MATCH TOTAL PENTAVALENT VACCINE AVAILABLE (FACTORING IN OPENING BALANCE):
  </ThemedText>
  {vaccineTotal && (
    <ThemedText style={styles.mismatch}>
      {vaccine5requiredToMatchPENTAAvail} pcs
    </ThemedText>
  )}
</View>

<View>
<Text style={styles.label}>ACTUAL PENTAVALENT 0.05ML SYRINGE QUANTITY ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
<TextInput
  style={styles.input}
  placeholder="Pentavalent 0.05ml syringe Quantity Issued "
...
<View style={styles.calc}>
  <ThemedText style={styles.subHeading}>
  QUANTITY OF 2ML SYRINGE REQUIRED TO MATCH TOTAL PENTAVALENT VACCINE AVAILABLE (FACTORING IN OPENING BALANCE):
  </ThemedText>
  {vaccineTotal && (
    <ThemedText style={styles.mismatch}>
...
<View>
<Text style={styles.label}>ACTUAL PENTAVALENT 2ML SYRINGE QUANTITY ISSUED </Text> 
<TextInput
    style={styles.input}
    placeholder="Pentavalent 2ml syringe Quantity Issued "
...
<View style={styles.questionaireContainer}>
  <ThemedText style={styles.subHeading}>PENTAVALENT VACCINE TEMP AT ISSUE</ThemedText>
  <View style={styles.ageGradeContainer}>
...
<ThemedText style={styles.subHeading}>PENTAVALENT VACCINE VVM STAGE AT ISSUE</ThemedText>
  <View style={styles.ageGradeContainer}>
...
<Text style={styles.buttonText}>
  Fill another Pentavalent Logistics form for a different manufacturer
</Text>
</TouchableOpacity>
...
<TextInput
      style={styles.input}
      placeholder="Pentavalent Vaccine batch number"
      value={batchNumbera}
...
<TextInput
      style={styles.input}
      placeholder="Pentavalent Vaccine expiring date.     Format: January 7, 2019"
      value={expiryDatea}
...
<TextInput
      style={styles.input}
      placeholder="Pentavalent Vaccine opening balance"
...
<View style={styles.questionaireContainer}>
  <ThemedText style={styles.subHeading}>Pentavalent Vaccine temp at pickup </ThemedText>
  <View style={styles.ageGradeContainer}>
...
<View  style={styles.questionaireContainer}>
  <ThemedText style={styles.subHeading}>Pentavalent Vaccine VVM stage at pickup </ThemedText>
  <View style={styles.ageGradeContainer}>
...
<TextInput
      style={styles.input}
      placeholder="Pentavalent Diluent batch number"
      value={diluentBatchNumber}
      onChangeText={setDiluentBatchNumber}
    />
...
<TextInput
      style={styles.input}
      placeholder="Pentavalent Diluent expiring date.     Format: MM/DD/YY 01/17/2019"
      value={diluentExpiryDate}
...
<TextInput
      style={styles.input}
      placeholder="Pentavalent Diluent opening balance"
      value={diluentOpeningBalancea}
      onChangeText={setDiluentOpeningBalancea}
    />
<View  style={styles.questionaireContainer}>
<ThemedText style={styles.subHeading}>Pentavalent Diluent mismatch adjustment: {}</ThemedText>
</View>


<TextInput
      style={styles.input}
      placeholder="Pentavalent 0.05ml syringe opening balance"
      value={syringeOpeningBalance}
      onChangeText={setSyringeOpeningBalance}
    />
...
<TextInput
      style={styles.input}
      placeholder="Pentavalent 2ml syringe opening balance"
      value={mlsyringeOpeningBalance}
      onChangeText={setMlsyringeOpeningBalance}
    />
...
<TextInput
    style={styles.input}
    placeholder="Pentavalent Vaccine average monthly requirement"
    value={averageMonthlyRequirement}
    onChangeText={setAverageMonthlyRequirement}
  /> 
...
<TextInput
    style={styles.input}
    placeholder="Pentavalent vaccine maximum stock quantity"
    value={maximumStock}
...
<TextInput
  style={styles.input}
  placeholder="Pentavalent vaccine doses to issue up to monthly MSQ"
