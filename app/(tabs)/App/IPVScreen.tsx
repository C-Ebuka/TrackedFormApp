...
export default function IPVScreen() {
  ...
  const [showAlertIPV, setShowAlertIPV] = useState(false);
  ...
  const [totalIpvDiluentAvailable, setTotalIpvDiluentAvailable] = useState('');
  const [vaccine5requiredToMatchIpvAvail, setVaccine5requiredToMatchIpvAvail] = useState('');
...
const handleIPVDateChange = (text: string) => {
  setExpiryDate(text);
  const validityMessage: string = isValidDate(text); // Ensure validityMessage is typed as string
  setShowAlertIPV(validityMessage !== 'valid' && text.trim().length > 0);
};
    ...
    const navigateBackward = () => {
      ...
      useEffect(() => {
        ...
        if (openingBalance && diluentOpeningBalance) {
          const ipvOpening = parseInt(openingBalance);
          const diluentOpening = parseInt(diluentOpeningBalance);
          const diluentMismatchAdjustment = ipvOpening - diluentOpening;
        ...
        if (vaccineTotal && syringeOpeningBalance) {
          const vaccine5requiredToMatchIpvAvailCalc = parseInt(vaccineTotal) - (Number(syringeOpeningBalance));
          setVaccine5requiredToMatchIpvAvail(vaccine5requiredToMatchIpvAvailCalc.toString()); 
        }
       
        if (diluentOpeningBalance && diluentIssued ) {
          const totalIpvDiluentAvailableCalc =  (parseInt(diluentOpeningBalance) + parseInt(diluentIssued));
          setTotalIpvDiluentAvailable(totalIpvDiluentAvailableCalc.toString());
    
        }
        
        if (diluentOpeningBalance && vaccineTotal && diluentIssued && totalIpvDiluentAvailable) {
          const dilAvailableMismatchCalc = parseInt(vaccineTotal) - (parseInt(totalIpvDiluentAvailable));
  ...
  return (
    <ParallaxScrollView
      ...
      <ThemedView style={styles.formContainer}>
        ...
        <ThemedText style={styles.header}>IPV LOGISTICS DATA</ThemedText>
        ...
        <View>
        <Text style={styles.label}>IPV VACCINE BATCH NUMBER</Text>
        <TextInput
              style={styles.input}
              placeholder="Enter IPV Vaccine batch number"
              value={batchNumber}
        ...
        <View>
          <Text style={styles.label}>IPV VACCINE EXPIRY DATE [MM/DD/YYYY]</Text>
          <TextInput
            style={styles.input}
            placeholder="Enter IPV Vaccine expiring date. Format: MM/DD/YYYY"
            value={expiryDate}
            onChangeText={handleIPVDateChange}
          />
          {showAlertIPV && (
        ...
        <View>
        <Text style={styles.label}>IPV DILUENT BATCH NUMBER</Text>
        <TextInput
              style={styles.input}
              placeholder="Enter IPV Diluent batch number"
        ...
        <View>
          <Text style={styles.label}>IPV DILUENT EXPIRY DATE [MM/DD/YYYY]</Text>
          <TextInput
            style={styles.input}
            placeholder="IPV Diluent expiring date. Format: MM/DD/YYYY"
        ...
        <View>
        <Text style={styles.label}>IPV 0.05ML SYRINGE BATCH NUMBER</Text>
        <TextInput
              style={styles.input}
              placeholder="Enter IPV Syringe 0.05ml batch number"
        ...
        <View>
          <Text style={styles.label}>IPV 0.05ML SYRINGE EXPIRY DATE [MM/DD/YYYY]</Text>
          <TextInput
            style={styles.input}
            placeholder="Enter IPV Syringe 0.05ml expiring date. Format: MM/DD/YYYY"
        ...
        <View>
        <Text style={styles.label}>IPV 2ML SYRINGE BATCH NUMBER</Text>
        <TextInput
              style={styles.input}
              placeholder="Enter IPV 2ml Syringe batch number"
        ...
        <View>
          <Text style={styles.label}>IPV 2ML SYRINGE EXPIRY DATE [MM/DD/YYYY]</Text>
          <TextInput
            style={styles.input}
            placeholder="IPV Syringe 2ml expiring date. Format: MM/DD/YYYY"
...
<View style={styles.questionaireContainer}>
          <ThemedText style={styles.subHeading}>IPV VACCINE TEMP AT PICK-UP</ThemedText>
  ...
  <View style={styles.questionaireContainer}>
    ...
    >
      ...
      <Picker.Item label="above 2 hrs" value="above 2 hrs" />
        ...
        <View  style={styles.questionaireContainer}>
          <ThemedText style={styles.subHeading}>IPV VACCINE VVM STAGE AT PICKUP </ThemedText>
          <View style={styles.ageGradeContainer}>
        ...
        <View>
        <Text style={styles.label}>IPV VACCINE OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text>
        <TextInput
              style={styles.input}
              placeholder="Enter IPV Vaccine opening balance"
        ...
        <View  style={styles.calc}>
          <ThemedText style={styles.subHeading}>IPV VACCINE OPENING BALANCE IN AMPOULES :</ThemedText>
          {openingBalance && (
        ...
        <View>
        <Text style={styles.label}>IPV DILUENT OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text>
        <TextInput
              style={styles.input}
              placeholder="Enter IPV Diluent opening balance"
        ...
        <View  style={styles.calc}>
          <ThemedText style={styles.subHeading}>IPV DILUENT OPENING BALANCE IN AMPOULES :</ThemedText>
          {diluentOpeningBalance && (
        ...
        <View  style={styles.calc}>
          <ThemedText style={styles.subHeading}>IPV DILUENT MISMATCH :</ThemedText>
          {diluentMismatch && (
            <>
              <ThemedText style={styles.mismatch}>
                {diluentMismatch} 
        ...
        <View>
        <Text style={styles.label}>IPV 0.05ML SYRINGE OPENING BALANCE (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
        <TextInput
              style={styles.input}
              placeholder="Enter IPV 0.05ml syringe opening balance"
        ...
        <View  style={styles.calc}>
          <ThemedText style={styles.subHeading}>IPV SYRINGE 0.05ML MISMATCH :</ThemedText>
          {syringe5mismatch && (
        ...
        <View>
        <Text style={styles.label}>IPV 2ML SYRINGE OPENING BALANCE </Text> 
        <TextInput
              style={styles.input}
              placeholder="Enter IPV 2ml syringe opening balance"
        ...
        <View  style={styles.calc}>
        <ThemedText style={styles.subHeading}>IPV SYRINGE 2ML MISMATCH :</ThemedText>
          {syringe2mismatch && (
              <ThemedText style={styles.mismatch}>
        ...
        <View>
        <Text style={styles.label}>IPV VACCINE AVERAGE MONTHLY REQUIREMENT  (AMR) (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
        <TextInput
            style={styles.input}
            placeholder="Enter IPV Vaccine average monthly requirement"
        ...
        <ThemedText style={styles.subHeading}>MMSQ MULTIPLICATION FACTOR:</ThemedText>
          ...
          <ThemedText style={styles.subHeading}>IPV VACCINE MONTHLY MAXIMUM STOCK QUANTITY:</ThemedText>
        ...
        <View style={styles.calc}>
          <ThemedText style={styles.subHeading}>
            IPV VACCINE DOSES REQUIRED TO MAKE UP TO MAXIMUM STOCK:
          </ThemedText>
          {dosesToIssueUp && (
            <ThemedText style={styles.mismatch}>
        ...
        <View>
        <Text style={styles.label}>ACTUAL IPV VACCINE DOSES ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
        <TextInput
          style={styles.input}
          placeholder="IPV vaccine doses issued "
        ...
        <View style={styles.calc}>
          <ThemedText style={styles.subHeading}>
         QUANTITY (DOSES) OF DILUENT REQUIRED TO MATCH TOTAL AVAILABLE IPV VACCINE (FACTORING IN OPENING BALANCE):
         </ThemedText>
        </View>
        <ThemedText>
          {vaccineTotal && (
        ...
        <View>
        <Text style={styles.label}>ACTUAL QUANTITY (DOSES) OF IPV DILUENT ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
        <TextInput
          style={styles.input}
          placeholder="IPV diluent issued "
          value={diluentIssued}
        ...
        <View style={styles.calc}>
          <ThemedText style={styles.subHeading}>
          QUANTITY OF 0.05ML SYRINGE REQUIRED TO MATCH TOTAL IPV VACCINE AVAILABLE (FACTORING IN OPENING BALANCE):
          </ThemedText>
          {vaccineTotal && (
            <ThemedText style={styles.mismatch}>
              {vaccine5requiredToMatchIpvAvail} pcs
            </ThemedText>
          )}
        </View>

        <View>
        <Text style={styles.label}>ACTUAL IPV 0.05ML SYRINGE QUANTITY ISSUED (PLEASE ENTER ONLY MULTIPLES OF 20)</Text> 
      <TextInput
          style={styles.input}
          placeholder="IPV 0.05ml syringe Quantity Issued "
        ...
        <View style={styles.calc}>
          <ThemedText style={styles.subHeading}>
          QUANTITY OF 2ML SYRINGE REQUIRED TO MATCH TOTAL IPV VACCINE AVAILABLE (FACTORING IN OPENING BALANCE):
          </ThemedText>
          {vaccineTotal && (
            <ThemedText style={styles.mismatch}>
        ...
        <View>
        <Text style={styles.label}>ACTUAL IPV 2ML SYRINGE QUANTITY ISSUED </Text> 
        <TextInput
            style={styles.input}
            placeholder="IPV 2ml syringe Quantity Issued "
  ...
  <View style={styles.questionaireContainer}>
          <ThemedText style={styles.subHeading}>IPV VACCINE TEMP AT ISSUE</ThemedText>
          <View style={styles.ageGradeContainer}>
      ...
      <View  style={styles.questionaireContainer}>
        ...
        <ThemedText style={styles.subHeading}>IPV VACCINE VVM STAGE AT ISSUE</ThemedText>
          <View style={styles.ageGradeContainer}>
      ...
      <TouchableOpacity onPress={handleGenerateFields} style={styles.buttonfill}>
        <Text style={styles.buttonText}>
          Fill another IPV Logistics form for a different manufacturer
        </Text>
      </TouchableOpacity>
        ...
        <TextInput
              style={styles.input}
              placeholder="IPV Vaccine batch number"
              value={batchNumbera}
        ...
        <TextInput
              style={styles.input}
              placeholder="IPV Vaccine expiring date.     Format: January 7, 2019"
              value={expiryDatea}
        ...
        <TextInput
              style={styles.input}
              placeholder="IPV Vaccine opening balance"
...
<View style={styles.questionaireContainer}>
          <ThemedText style={styles.subHeading}>IPV Vaccine temp at pickup </ThemedText>
          <View style={styles.ageGradeContainer}>
        ...
        <TextInput
              style={styles.input}
              placeholder="IPV Diluent batch number"
              value={diluentBatchNumber}
              onChangeText={setDiluentBatchNumber}
            />
        ...
        <TextInput
              style={styles.input}
              placeholder="IPV Diluent expiring date.     Format: MM/DD/YY 01/17/2019"
              value={diluentExpiryDate}
        ...
        <TextInput
              style={styles.input}
              placeholder="IPV Diluent opening balance"
              value={diluentOpeningBalancea}
              onChangeText={setDiluentOpeningBalancea}
            />
        <View  style={styles.questionaireContainer}>
        <ThemedText style={styles.subHeading}>IPV Diluent mismatch adjustment: {}</ThemedText>
        </View>

        
        <TextInput
              style={styles.input}
              placeholder="IPV 0.05ml syringe opening balance"
              value={syringeOpeningBalance}
              onChangeText={setSyringeOpeningBalance}
            />
        ...
        <TextInput
              style={styles.input}
              placeholder="IPV 2ml syringe opening balance"
              value={mlsyringeOpeningBalance}
              onChangeText={setMlsyringeOpeningBalance}
            />
        ...
        <TextInput
            style={styles.input}
            placeholder="IPV Vaccine average monthly requirement"
            value={averageMonthlyRequirement}
            onChangeText={setAverageMonthlyRequirement}
          /> 
        ...
        <TextInput
            style={styles.input}
            placeholder="IPV vaccine maximum stock quantity"
            value={maximumStock}
        ...
        <TextInput
          style={styles.input}
          placeholder="IPV vaccine doses to issue up to monthly MSQ"
